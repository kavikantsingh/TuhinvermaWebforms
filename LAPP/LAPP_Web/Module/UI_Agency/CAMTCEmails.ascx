<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CAMTCEmails.ascx.cs" Inherits="Module_UI_Agency_CAMTCEmails" %>
    ...
    <ContentTemplate>
        ...
        <div class="dashboard-header">
            <div class="float_left">
                ...
                <p style="text-align: left;">
                    <a href="#">Search Database</a> | <a href="#">Change Password</a> | <a href="Login.aspx">Sign Out</a>
                </p>
            </div>
                    ...
                    <div id="divAdvanceSearch" runat="server" visible="false">
                        <table style="height: 355px;" class="tablecs">
                            <tr>
                                ...
                                <td colspan="5">
                                    <asp:TextBox ID="txtSearchByName" ClientIDMode="Static" runat="server" Style="width: 440px  !important;" CssClass="inputTextbox" MaxLength="50"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList Style="width: 135px !important;" ID="DropDownList1"
                                        runat="server">
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <asp:TextBox ID="TextBox7" runat="server" Style="width: 440px  !important;" CssClass="inputTextbox"
                                        MaxLength="50"></asp:TextBox>
                                </td>
                                <%--<td align="right">
                                            <label>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <asp:DropDownList Style="width: 135px !important;" ID="ddlRecordStatus"
                                        runat="server">
                                        <asp:ListItem Value="-1">Select</asp:ListItem>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList Style="width: 135px !important;" ID="DropDownList2"
                                        runat="server">
                                        <asp:ListItem Value="-1">Select</asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                    ...
                    <div id="divBasicSearch" runat="server">
                        <table style="height: 200px; margin: 0 auto;" class="tablecs">
                            <tr>
                                ...
                                <td colspan="5">
                                    <asp:TextBox ID="txtSearchByName2" ClientIDMode="Static" runat="server" Style="width: 440px  !important;" CssClass="inputTextbox" MaxLength="50"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <asp:TextBox ID="txtMiddleName" runat="server" Style="width: 440px  !important;" CssClass="inputTextbox"
                                        MaxLength="50"></asp:TextBox>
                                </td>
        ...
        <div style="clear: both; overflow: hidden;">
            <div class="dashbaord-container" style="line-height: 29px; font-weight: bold;">
                <%--<asp:Button ID="lnkSearhApplicant" CssClass="buttonGreen medium" runat="server"
                    Text="Search Database" />--%>
                <h4 style="">CAMTC's Email Contacts :</h4>
                <table style="line-height: 29px; font-weight: bold;">
                    <tr>
                        <td style="width: 300px; text-align: left; padding-left: 35px;">
                            <a href="mailto:bmay@camtc.org" class="link">Director of Governmental Affairs</a>
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 300px; text-align: left; padding-left: 35px;">
                            <a href="mailto:complaints@camtc.org" class="link">Conplaints</a>
                        </td>
                    </tr>
                </table>
                <br />

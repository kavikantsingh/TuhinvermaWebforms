...
public partial class ucCertificationApplication : System.Web.UI.UserControl
{
    ...
    protected void lnkQues2_Click(object sender, EventArgs e)
    {
    ...
    protected void btnapprovedschools1AddNew_Click(object sender, EventArgs e)
    {
        divapprovedschools1.Visible = false;
        divAddPanelapprovedschools1.Visible = true;
        //this.EditIndexEducation = -1;
        //BindGridEducation();
    }
    protected void btnapprovedschools1Save_Click(object sender, EventArgs e)
    {
        divapprovedschools1.Visible = true;
        divAddPanelapprovedschools1.Visible = false;
    }
    protected void lnkapprovedschools1Cancel_Click(object sender, EventArgs e)
    {
        divapprovedschools1.Visible = true;
        divAddPanelapprovedschools1.Visible = false;
    }
    ...
    protected void rblHistoryQ6_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            divhist7.Visible = true;
        }
        else
        {
            divhist7.Visible = false;
        }
    }
    ...
    protected void ddlLicenseInfoStatus_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (ddlLicenseInfoStatus.SelectedValue == "2")
        {
            ...
            txtLicensInfoReason.Visible = true;
        }
            
        else
        {
            lblReason.Visible = false;
            txtLicensInfoReason.Visible = false;
        }
    }

    ...
    <div class="float_left">
        <h4 style="text-align: left; margin: 0px !important;">
            <asp:Literal ID="ltrDashboard" runat="server">Dashboard</asp:Literal><span>
                <asp:LinkButton ID="lnkBacktoDashboard" runat="server" PostBackUrl="~/LAPP_UI_Individual/UI/ApplicantDashboard.aspx">&larr; Back to Dashboard</asp:LinkButton></span></h4>
        <p style="font-size: 15px;">
            Welcome <span class= "bold"> Nancy Blachly </span>| <a href="ChangePassword.aspx?q=2">Change

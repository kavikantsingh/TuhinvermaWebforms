<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucOwnAdminDashboard.ascx.cs" Inherits="Module_UI_School_ucOwnAdminDashboard" %>
            ...
            <EmptyDataTemplate>
                <div style="width: 100%; height: 50px; border: 0px; padding: 3px">
                    No record found.
                        ...
                        <div id="divGridPhysicalAddress" runat="server" style="display:none;" class="divquestion divCharacterReferences">

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucOwnerDashboard.ascx.cs" Inherits="Module_UI_School_ucOwnerDashboard" %>
                    ...
                    <div class="dashboard-block dashboard-border" style="display:none;">
                        <div class="dashboard-block-header" style="padding: 6px 10px 10px 5px;">
                            Task Detail <span class="fltrt">
                                <asp:Button ID="EditMailingbtn" runat="server" style=" display:none;" Visible="true" ToolTip="Edit" CssClass="Editbtn imgDelete small"
            ...
            <EmptyDataTemplate>
                <div style="width: 100%; height: 50px; border: 0px; padding: 3px">
                    No record found.
                        ...
                        <div id="divGridPhysicalAddress" runat="server" class="divquestion divCharacterReferences" style="display:none;">
                ...
                <div class="dashboard-block-right-bottom dashboard-border">
                    ...
                    <div>
                        ...
                        <table class="additionl-links" style="margin: 5px; line-height: 20px;">
                            ...
                            <tr>
                                <td>
                                    <a href="../../LAPP_UI_School/UI/SchoolApplication.aspx?AOS=SGEL" target="_blank">Student/Graduate Eligibility List</a>
                                </td>
                            </tr>

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucAdminInstructorDashboard.ascx.cs" Inherits="Module_UI_School_ucAdminInstructorDashboard" %>
    ...
    <div>
        <asp:GridView ID="gvUserTask" ClientIDMode="Static" runat="server" AutoGenerateColumns="False"
            ...
            <EmptyDataTemplate>
                <div style="width: 100%; height: 50px; border: 0px; padding: 3px">
                    No record found.
                        ...
                        <div id="divGridMailingAddress" style=" display:none;" runat="server" class="divquestion divCharacterReferences">
                            <div style="height: 30px; border-bottom: solid 1px #e5e5e5;">
                                <table style="margin: 8px; width: 97%; margin: 0 auto;">
                                    <tr>
                                        <td align="left" style="vertical-align: middle;">
                    ...
                    <div class="dashboard-block dashboard-border">
                        <div class="dashboard-block-header" style="padding: 6px 10px 10px 5px;">
                            Contact Detail <span class="fltrt">
                                <asp:Button ID="btnEditContact" runat="server" Visible="true" ToolTip="Edit" CssClass="Editbtn imgDelete small"
            ...
            <div class="dashboard-block-right">
                ...
                <div class="dashboard-block-right-bottom dashboard-border" style="display:none;">
                    <div class="dashboard-block-header">
                        Payment Detail
                    </div>
                    <table class="AppDetailsHeader">
                ...
                <div class="dashboard-block-right-bottom dashboard-border">
                    ...
                    <div>
                        <table class="additionl-links" style="margin: 5px; line-height: 20px;">
                            ...
                            <tr>
                                <td>
                                    <a href="../../LAPP_UI_School/UI/SchoolApplication.aspx?AOS=MAP" target="_blank">Manage Approvals and Programs</a>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <a href="../../LAPP_UI_School/UI/SchoolApplication.aspx?AOS=MGNM" target="_blank">Manage Graduate Numbers and Miscellaneous</a>
                                </td>
                            </tr>

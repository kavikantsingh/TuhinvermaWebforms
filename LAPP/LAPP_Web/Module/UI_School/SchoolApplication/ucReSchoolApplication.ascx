<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucReSchoolApplication.ascx.cs"
                                                                ...
                                                                <td colspan="6">
                                                                    <table class="tblApplReqForm5" style="margin-top: -7px;">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <asp:TextBox ID="txtDOB" runat="server" Text="06/08/1952" placeholder="MM/DD/YYYY" CssClass="inputTextbox calenderDOB NewAppPersonalTxtbx calenderDOB"
                                                                                    MaxLength="150"></asp:TextBox>
                                                                            </td>
                                                                            <td class="txtalgnrgt" style="line-height: 20px;">
                                                                                <label style="display: block; position: relative; left: -6px;">
                                                                                    Driver's License #<br />
                                                                                    (or State ID) :
                                                                                </label>
                                                                            </td>
                                                    ...
                                                    <fieldset class="flsNewApplReqForm flsCharacterReferences">
                                                        ...
                                                        <table class="tblApplReqForm5" style="margin: 0px auto; width: 100%;">
                                                            <tr>
                                                                ...
                                                                <td style="width: 590px; padding-left: 0px; line-height: 20px; text-align: justify;">Since the date you signed and dated your initial application for certification to
                                                                                ...
                                                                                <table class="index pdgnone brdr  grid" id="Table9" style="color: #333333; width: 90%; margin: 10px auto; border-collapse: collapse;"
                                                                                    ...
                                                                                    <tbody>
                                                                                        ...
                                                                                        <tr class="bordrbtm gridrow">
                                                                                            ...
                                                                                            <td>
                                                                                                <span>
                                                                                                    <input id="Image5" title="Delete" class="imgDelete" src="../../App_Themes/Public/images/delete.png"
                                                                                                        type="image"></span>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </tbody>

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucInHouseClearance.ascx.cs" Inherits="Module_UI_Backoffice_Workflow_ucInHouseClearance" %>
<asp:UpdatePanel runat="server" ID="upPnlCertificateApp">
    <ContentTemplate>
                ...
                <table class="index  grid" cellspacing="0" cellpadding="5" id="gvNewApplication"
                    ...
                    <tbody>
                        <tr>
                            ...
                            <th class="aligncenter" scope="col" style="width: 233px;">Action
                            </th>
                        </tr>
                        <tr id="trGridRowStatus1" runat="server">
                            ...
                            <td>
                                <asp:DropDownList ID="DropDownList28" runat="server" Style="width: 115px;">
                                    <asp:ListItem Value="-1">Select</asp:ListItem>
                                    <asp:ListItem Value="1">Cleared To AMG</asp:ListItem>
                                    <asp:ListItem Selected="True" Value="2">PSD Waiting Room</asp:ListItem>
                                </asp:DropDownList>
                            </td>
                            <td align="center" valign="middle">
                                <asp:Button ID="Button3" CssClass="buttonGreen small" runat="server" Text="Submit" />
                            ...
                            <td colspan="9" style="padding: 0px;">
                                ...
                                <div class="toolBar">
                                    <table style="width: 100%; table-layout: fixed;">
                                        <tr>
                                            <td style="width: 145px; font-weight: bold; padding: 0px 3px; text-align: center;">CAMTC00123
                                            </td>
                                            <td style="width: 156px; font-weight: bold; padding: 0px;">250
                                            </td>
                                            <td style="width: 100px; font-weight: bold; padding: 0px;">Nancy
                                            </td>
                                            <td style="width: 60px;">CH
                                            </td>
                                            <td style="width: 110px; font-weight: bold; padding: 0px;">Blachly
                                            </td>
                                            <td style="width: 135px; font-weight: bold; padding: 0px;">01/24/2014
                                            </td>
                        ...
                        <tr id="tr1" runat="server" style="color: blue;">
                            <td>
                            ...
                            <td align="center" valign="middle">
                                <asp:Button ID="Button4" CssClass="buttonGreen small" runat="server" Text="Submit" />
        ...
        <div class="applicationform" style="width: 100%">
            ...
            <div class="toolBar" style="padding: 4px; width:100%;" runat="server" id="Div6">
                        ...
                        <table class="" style="width:100%;">
                            <tbody>
                                <tr>
                                    ...
                                    <td style="text-align:right;"><asp:ImageButton ID="ImageButton1" ToolTip="Hold" runat="server" Width="22px"

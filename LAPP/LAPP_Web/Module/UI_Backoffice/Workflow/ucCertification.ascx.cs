...
public partial class Module_UI_Backoffice_Workflow_ucCertification : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            BindGridWorkInfo3();
            BindGridWorkInfo4();
            BindGridEducation2SCL();
            BindGridEducationSCL();
            BindExamsSCL();
    ...
    protected void gvEducation1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (lblBusinessName2 != null && lblBusinessPhone2 != null && lblCity2 != null && lblState2 != null && lblZip2 != null)
            {
                ...
                {
                    lblBusinessName2.Text = "DAVIDS ACADEMY OF BEAUTY";
    ...
    protected void btnSCLEducation2AddNew_Click(object sender, EventArgs e)
    {
        divSCLEducationt2.Visible = false;
        divAddSCLPanelEducation2.Visible = true;
        this.EditIndexEducation2 = -1;
        BindGridEducation2();
    }
    ...
    protected void lnkSCLEducation2Cancel_Click(object sender, EventArgs e)
    {
        divSCLEducationt2.Visible = true;
        divAddSCLPanelEducation2.Visible = false;
    }
    ...
    #region Education 2 16A

    public int EditIndexEducation2DUB
    {
        get
        {
            if (ViewState["EditIndexEducation2DUB"] != null)
            {
                return Convert.ToInt32(ViewState["EditIndexEducation2DUB"]);
        ...
        set
        {
            ViewState["EditIndexEducation2DUB"] = value;
        }
    }

    protected void btnEducation2AddNewDUB_Click(object sender, EventArgs e)
    {
        divEducationt2DUB.Visible = false;
        divAddPanelEducation2DUB.Visible = true;
        this.EditIndexEducation2DUB = -1;
        BindGridEducation2DUB();
    }

    protected void btnEducation2SaveDUB_Click(object sender, EventArgs e)
    {
        divEducationt2DUB.Visible = true;
        divAddPanelEducation2DUB.Visible = false;
    }


    protected void lnkEducation2CancelDUB_Click(object sender, EventArgs e)
    {
        divEducationt2DUB.Visible = true;
        divAddPanelEducation2DUB.Visible = false;
    }
    ...
    protected void gvEducation2DUB_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {

            Label lblMassageSchoolNameDUB = e.Row.FindControl("lblMassageSchoolNameDUB") as Label;
            Label lblDateStartDUB = e.Row.FindControl("lblDateStartDUB") as Label;
            Label lblTotalHRSDUB = e.Row.FindControl("lblTotalHRSDUB") as Label;

            if (lblMassageSchoolNameDUB != null && lblDateStartDUB != null && lblTotalHRSDUB != null)
            {
                if (ROWEdu2DUB == 0)
                {

                    lblMassageSchoolNameDUB.Text = "SCHOOL OF ACUPUNTURE ";
                    lblDateStartDUB.Text = "02/04/2014";
                    lblTotalHRSDUB.Text = "201";
                }
                else if (ROWEdu2DUB == 1)
                {
                    lblMassageSchoolNameDUB.Text = "NATIONAL HOLISTIC INSTITUTE";
                    lblDateStartDUB.Text = "08/01/2014";
                    lblTotalHRSDUB.Text = "302";
                }
            }
    ...
    public void BindGridEducation2DUB()
    {
        ...
        gvEducation2DUB.EditIndex = this.EditIndexEducation2DUB;
        gvEducation2DUB.DataSource = ArryListName;
        gvEducation2DUB.DataBind();

        if (this.EditIndexEducation2DUB >= 0)
        {
            gvEducation2DUB.Rows[this.EditIndexEducation2DUB].CssClass = "RowInEditMode";
            gvEducation2DUB.Rows[this.EditIndexEducation2DUB].Cells[0].Attributes.Add("colspan", "5");
            gvEducation2DUB.Rows[this.EditIndexEducation2DUB].Cells[1].Visible = false;
            gvEducation2DUB.Rows[this.EditIndexEducation2DUB].Cells[2].Visible = false;
            gvEducation2DUB.Rows[this.EditIndexEducation2DUB].Cells[3].Visible = false;
            gvEducation2DUB.Rows[this.EditIndexEducation2DUB].Cells[4].Visible = false;

        }
    }

    public void FillControlEducation2DUB(GridView gv, int EditInd)
    {
        try
        {
            TextBox txtEducationStartDateEditDUB = gv.Rows[this.EditIndexEducation2DUB].FindControl("txtEducationStartDateEditDUB") as TextBox;
            TextBox txtEducationEndDateEditDUB = gv.Rows[this.EditIndexEducation2DUB].FindControl("txtEducationEndDateEditDUB") as TextBox;
            TextBox txtEducationHRSEditDUB = gv.Rows[this.EditIndexEducation2DUB].FindControl("txtEducationHRSEditDUB") as TextBox;

            txtEducationStartDateEditDUB.Text = "01/02/2012";
            txtEducationEndDateEditDUB.Text = "02/04/2014";
            txtEducationHRSEditDUB.Text = "201";
        }
    ...
    protected void btnEducation2UpdateDUB_Click(object sender, EventArgs e)
    {
        this.EditIndexEducation2DUB = -1;
        BindGridEducation2DUB();
    }

    protected void lnkEducation2CancelUpdateDUB_Click(object sender, EventArgs e)
    {
        this.EditIndexEducation2DUB = -1;
        BindGridEducation2DUB();
    }

    protected void lnkEducation2EditDUB_Click(object sender, EventArgs e)
    {
        divEducationt2DUB.Visible = true;
        divAddPanelEducation2DUB.Visible = false;
        this.EditIndexEducation2DUB = -1;

        ImageButton imgbtnEducation2EditDUB = (ImageButton)sender;
        if (imgbtnEducation2EditDUB != null)
        {
            int ID = Convert.ToInt32(imgbtnEducation2EditDUB.CommandArgument);
            this.EditIndexEducation2DUB = Convert.ToInt32(imgbtnEducation2EditDUB.Attributes["RowIndex"]);
            BindGridEducation2DUB();
            FillControlEducation2DUB(gvEducation2DUB, this.EditIndexEducation2DUB);
        }
    }

    protected void lnkEducation2DeleteDUB_Click(object sender, EventArgs e)
    {
    ...
    protected void lnkCOMPCancelUpdate_Click(object sender, EventArgs e)
    {
        trEditMode.Visible = false;
        trDeficiency.Visible = false;
        trComplaint.Visible = false;
        trGridRow.Visible = true;
    }
    protected void btnCOMPverifyCancel_Click(object sender, EventArgs e)
    {
        pnlAddnewComplaint.Visible = false;
        pnlAddnewButtonBGC.Visible = true;
        pnlAddnewButtonComplaint.Visible = true;
    }
    protected void btnBCcompalint_Click(object sender, EventArgs e)
    {
        pnlAddnewComplaint.Visible = false;
        pnlAddnewButtonBGC.Visible = true;
    }
    ...
    {
        pnlAddnewComplaint.Visible = true;
        pnlAddnewButtonComplaint.Visible = false;
    }

    protected void imgbtncomplaint_Click(object sender, EventArgs e)
{
    trEditMode.Visible = false;
    trGridRow.Visible = false;
    btnAddNewApp.Visible = true;
    ...
    #endregion
    protected void ddlLicenseInfoStatus_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (ddlLicenseInfoStatus.SelectedValue == "2")
            txtLicensInfoReason.Enabled = true;
        else
            txtLicensInfoReason.Enabled = false;
    }
    protected void imbtnSCL_Click(object sender, ImageClickEventArgs e)
    {
    ...
    protected void lnkSCLCancle_Click(object sender, EventArgs e)
    {
    ...
    #region Education 1 SCL

    public int EditIndexEducationSCL
    {
        get
        {
            if (ViewState["EditIndexEducationSCL"] != null)
            {
                return Convert.ToInt32(ViewState["EditIndexEducationSCL"]);
        ...
        set
        {
            ViewState["EditIndexEducationSCL"] = value;
        }
    }

    protected void btnEducation1AddNewSCL_Click(object sender, EventArgs e)
    {
        divEducationt1SCL.Visible = false;
        divAddPanelEducation1SCL.Visible = true;
        this.EditIndexEducationSCL = -1;
        BindGridEducationSCL();
    }
    protected void btnEducation1SaveSCL_Click(object sender, EventArgs e)
    {
        divEducationt1SCL.Visible = true;
        divAddPanelEducation1SCL.Visible = false;
    }
    protected void lnkEducation1CancelSCL_Click(object sender, EventArgs e)
    {
        divEducationt1SCL.Visible = true;
        divAddPanelEducation1SCL.Visible = false;
    }
    ...
    protected void gvEducation1SCL_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {

            Label lblBusinessName2SCL = e.Row.FindControl("lblBusinessName2SCL") as Label;
            Label lblBusinessPhone2SCL = e.Row.FindControl("lblBusinessPhone2SCL") as Label;
            Label lblCity2SCL = e.Row.FindControl("lblCity2SCL") as Label;
            Label lblState2SCL = e.Row.FindControl("lblState2SCL") as Label;
            Label lblZip2SCL = e.Row.FindControl("lblZip2SCL") as Label;

            if (lblBusinessName2SCL != null && lblBusinessPhone2SCL != null && lblCity2SCL != null && lblState2SCL != null && lblZip2SCL != null)
            {
                if (ROWEdu1SCL == 0)
                {

                    lblBusinessName2SCL.Text = "Dolce Salon and Spa";
                    lblBusinessPhone2SCL.Text = "(530) 542-0604";
                    lblCity2SCL.Text = "EMERYVILLE";
                    lblState2SCL.Text = "CA";
                    lblZip2SCL.Text = "96151";
                }
                else if (ROWEdu1SCL == 1)
                {
                    lblBusinessName2SCL.Text = "Professional Massage Inc.";
                    lblBusinessPhone2SCL.Text = "(775) 742-0000";
                    lblCity2SCL.Text = "TEMPLE CITY";
                    lblState2SCL.Text = "CA";
                    lblZip2SCL.Text = "89450";
                }
            }
    ...
    public void BindGridEducationSCL()
    {
        ...
        gvEducation1SCL.EditIndex = this.EditIndexEducationSCL;
        gvEducation1SCL.DataSource = ArryListName;
        gvEducation1SCL.DataBind();

        if (this.EditIndexEducation >= 0)
        {
            gvEducation1SCL.Rows[this.EditIndexEducationSCL].CssClass = "RowInEditMode";
            gvEducation1SCL.Rows[this.EditIndexEducationSCL].Cells[0].Attributes.Add("colspan", "6");
            gvEducation1SCL.Rows[this.EditIndexEducationSCL].Cells[1].Visible = false;
            gvEducation1SCL.Rows[this.EditIndexEducationSCL].Cells[2].Visible = false;
            gvEducation1SCL.Rows[this.EditIndexEducationSCL].Cells[3].Visible = false;
            gvEducation1SCL.Rows[this.EditIndexEducationSCL].Cells[4].Visible = false;
            gvEducation1SCL.Rows[this.EditIndexEducationSCL].Cells[5].Visible = false;
        }
    }

    public void FillControlEducation1SCL(GridView gv, int EditInd)
    {
        try
        {
            TextBox txtEdu1SchoolNameEditSCL = gv.Rows[this.EditIndexEducationSCL].FindControl("txtEdu1SchoolNameEditSCL") as TextBox;
            TextBox txtEdu1CityEditSCL = gv.Rows[this.EditIndexEducationSCL].FindControl("txtEdu1CityEditSCL") as TextBox;
            TextBox txtEdu1ZipEditSCL = gv.Rows[this.EditIndexEducationSCL].FindControl("txtEdu1ZipEditSCL") as TextBox;
            TextBox txtEdu1SchoolPhoneEditSCL = gv.Rows[this.EditIndexEducationSCL].FindControl("txtEdu1SchoolPhoneEditSCL") as TextBox;
            DropDownList ddlEdu1StateEditSCL = gv.Rows[this.EditIndexEducationSCL].FindControl("ddlEdu1StateEditSCL") as DropDownList;
            DropDownList ddlEduCountryNameEditSCL = gv.Rows[this.EditIndexEducationSCL].FindControl("ddlEduCountryNameEditSCL") as DropDownList;


            txtEdu1SchoolNameEditSCL.Text = "NATIONAL HOLISTIC INSTITUTE";
            ddlEdu1StateEditSCL.SelectedValue = "CA";
            txtEdu1SchoolPhoneEditSCL.Text = "(530) 542-0604";
            ddlEduCountryNameEditSCL.SelectedValue = "US";
            txtEdu1ZipEditSCL.Text = "96151";
            txtEdu1CityEditSCL.Text = "EMERYVILLE";
    ...
    protected void btnEducation1UpdateSCL_Click(object sender, EventArgs e)
    {
        this.EditIndexEducationSCL = -1;
        BindGridEducationSCL();
    }

    protected void lnkEducation1CancelUpdateSCL_Click(object sender, EventArgs e)
    {
        this.EditIndexEducationSCL = -1;
        BindGridEducationSCL();
    }

    protected void lnkEducation1EditSCL_Click(object sender, EventArgs e)
    {
        divEducationt1SCL.Visible = true;
        divAddPanelEducation1SCL.Visible = false;
        this.EditIndexEducationSCL = -1;

        ImageButton imgbtnEducation1EditSCL = (ImageButton)sender;
        if (imgbtnEducation1EditSCL != null)
        {
            int ID = Convert.ToInt32(imgbtnEducation1EditSCL.CommandArgument);
            this.EditIndexEducationSCL = Convert.ToInt32(imgbtnEducation1EditSCL.Attributes["RowIndex"]);
            BindGridEducationSCL();
            FillControlEducation1SCL(gvEducation1SCL, this.EditIndexEducationSCL);
        }
    }

    protected void lnkEducation1DeleteSCL_Click(object sender, EventArgs e)
    {
    ...
    #region SChool Education 2

    public int EditIndexEducation2SCL
    {
        get
        {
            if (ViewState["EditIndexEducation2SCL"] != null)
            {
                return Convert.ToInt32(ViewState["EditIndexEducation2SCL"]);
        ...
        set
        {
            ViewState["EditIndexEducation2SCL"] = value;
        }
    }

    protected void btnEducation2AddNewSCL_Click(object sender, EventArgs e)
    {
        divSCLEducationt2.Visible = false;
        divAddSCLPanelEducation2.Visible = true;
        
        this.EditIndexEducation2SCL = -1;
        BindGridEducation2SCL();
    }
    protected void btnEducation2SaveSCL_Click(object sender, EventArgs e)
    {
        divSCLEducationt2.Visible = true;
        divAddSCLPanelEducation2.Visible = false;
    }
    protected void lnkEducation2CancelSCL_Click(object sender, EventArgs e)
    {
        divSCLEducationt2.Visible = true;
        divAddSCLPanelEducation2.Visible = false;
    }
    ...
    protected void gvEducation2SCL_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {

            Label lblMassageSchoolNameSCL = e.Row.FindControl("lblMassageSchoolNameSCL") as Label;
            Label lblDateStartSCL = e.Row.FindControl("lblDateStartSCL") as Label;
            Label lblTotalHRSSCL = e.Row.FindControl("lblTotalHRSSCL") as Label;

            if (lblMassageSchoolNameSCL != null && lblDateStartSCL != null && lblTotalHRSSCL != null)
            {
                if (ROWEdu2SCL == 0)
                {

                    lblMassageSchoolNameSCL.Text = "SCHOOL OF ACUPUNTURE ";
                    lblDateStartSCL.Text = "02/04/2014";
                    lblTotalHRSSCL.Text = "201";
                }
                else if (ROWEdu2SCL == 1)
                {
                    lblMassageSchoolNameSCL.Text = "NATIONAL HOLISTIC INSTITUTE";
                    lblDateStartSCL.Text = "08/01/2014";
                    lblTotalHRSSCL.Text = "302";
                }
            }
    ...
    public void BindGridEducation2SCL()
    {
        ...
        gvEducation2SCL.EditIndex = this.EditIndexEducation2SCL;
        gvEducation2SCL.DataSource = ArryListName;
        gvEducation2SCL.DataBind();

        if (this.EditIndexEducation2SCL >= 0)
        {
            gvEducation2SCL.Rows[this.EditIndexEducation2SCL].CssClass = "RowInEditMode";
            gvEducation2SCL.Rows[this.EditIndexEducation2SCL].Cells[0].Attributes.Add("colspan", "5");
            gvEducation2SCL.Rows[this.EditIndexEducation2SCL].Cells[1].Visible = false;
            gvEducation2SCL.Rows[this.EditIndexEducation2SCL].Cells[2].Visible = false;
            gvEducation2SCL.Rows[this.EditIndexEducation2SCL].Cells[3].Visible = false;
            gvEducation2SCL.Rows[this.EditIndexEducation2SCL].Cells[4].Visible = false;

        }
    }

    public void FillControlEducation2SCL(GridView gv, int EditInd)
    {
        try
        {
            TextBox txtEducationStartDateEditSCL = gv.Rows[this.EditIndexEducation2SCL].FindControl("txtEducationStartDateEditSCL") as TextBox;
            TextBox txtEducationEndDateEditSCL = gv.Rows[this.EditIndexEducation2SCL].FindControl("txtEducationEndDateEdit") as TextBox;
            TextBox txtEducationHRSEditSCL = gv.Rows[this.EditIndexEducation2SCL].FindControl("txtEducationHRSEditSCL") as TextBox;

            txtEducationStartDateEditSCL.Text = "01/02/2012";
            txtEducationEndDateEditSCL.Text = "02/04/2014";
            txtEducationHRSEditSCL.Text = "201";
        }
    ...
    protected void btnEducation2UpdateSCL_Click(object sender, EventArgs e)
    {
        this.EditIndexEducation2SCL = -1;
        BindGridEducation2SCL();
    }

    protected void lnkEducation2CancelUpdateSCL_Click(object sender, EventArgs e)
    {
        this.EditIndexEducation2SCL = -1;
        BindGridEducation2SCL();
    }

    protected void lnkEducation2EditSCL_Click(object sender, EventArgs e)
    {
        divSCLEducationt2.Visible = true;
        divAddSCLPanelEducation2.Visible = false;
        this.EditIndexEducation2SCL = -1;

        ImageButton imgbtnEducation2EditSCL = (ImageButton)sender;
        if (imgbtnEducation2EditSCL != null)
        {
            int ID = Convert.ToInt32(imgbtnEducation2EditSCL.CommandArgument);
            this.EditIndexEducation2SCL = Convert.ToInt32(imgbtnEducation2EditSCL.Attributes["RowIndex"]);
            BindGridEducation2SCL();
            FillControlEducation2SCL(gvEducation2SCL, this.EditIndexEducation2SCL);
        }
    }

    protected void lnkEducation2DeleteSCL_Click(object sender, EventArgs e)
    {
    ...
    public int EditIndexExamSCL
    {
        get
        {
            if (ViewState["EditIndexExamSCL"] != null)
            {
                return Convert.ToInt32(ViewState["EditIndexExamSCL"]);
        ...
        set
        {
            ViewState["EditIndexExamSCL"] = value;
        }
    }
    public void BindExamsSCL()
    {
        //Bind exam list
        ArrayList ArryListExamSCL = new ArrayList();
        ArryListExamSCL.Add("CA");


        gvExamsSCL.EditIndex = this.EditIndexExamSCL;
        gvExamsSCL.DataSource = ArryListExamSCL;
        gvExamsSCL.DataBind();

        if (this.EditIndexExamSCL >= 0)
        {
            gvExamsSCL.Rows[this.EditIndexExamSCL].CssClass = "RowInEditMode";
            gvExamsSCL.Rows[this.EditIndexExamSCL].Cells[0].Attributes.Add("colspan", "3");
            gvExamsSCL.Rows[this.EditIndexExamSCL].Cells[1].Visible = false;
            gvExamsSCL.Rows[this.EditIndexExamSCL].Cells[2].Visible = false;

        }

    }
    protected void btnAddNewQ22SCL_Click(object sender, EventArgs e)
    {

        tbpAddNewQ22SCL.Visible = true;
        divAddButtonQ22SCL.Visible = false;
    }
    protected void btnSaveNewQ22SCL_Click(object sender, EventArgs e)
    {

        tbpAddNewQ22SCL.Visible = false;
        divAddButtonQ22SCL.Visible = true;
    }

    protected void btnCancelNewQ22SCL_Click(object sender, EventArgs e)
    {
        tbpAddNewQ22SCL.Visible = false;
        divAddButtonQ22SCL.Visible = true;
    }
    ...
    protected void btnSaveNewQ22EditSCL_Click(object sender, EventArgs e)
    {

        this.EditIndexExamSCL = -1;
        BindExamsSCL();
    }

    protected void btnCancelNewQ22EditSCL_Click(object sender, EventArgs e)
    {
        this.EditIndexExamSCL = -1;
        BindExamsSCL();
    }
    protected void lnkExam1EditSCL_Click(object sender, EventArgs e)
    {
        this.EditIndexExamSCL = 0;
        BindExamsSCL();
    }
    protected void lnkExam1DeleteSCL_Click(object sender, EventArgs e) { }

    #endregion
    protected void imgbtnHistory_Click(object sender, ImageClickEventArgs e)
    {
        Session["IndividualTabChange"] = "DOJFBI";
        Response.Redirect("~/LAPP_UI_Backoffice/UI/individual.aspx");
    }
    protected void chkSelectAll_CheckedChanged(object sender, EventArgs e)
    {
        if (chkSelectAll.Checked==true)
        {
            ...
            CHKCert2.Checked = true;
        }
        else
        {
            CHKCer1.Checked = false;
            CHKCert2.Checked = false;
        }
    }
}
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucPSDDoSubinOpposition.ascx.ascx.cs" Inherits="Module_UI_Backoffice_PSD_ucPSDDoSubinOpposition_ascx" %>
...
<div class="clear textBoxAlign" style="padding-bottom: 40px;">
    <div style="border: 1px solid #d4d8db; margin-top: 10px;">
        ...
        <table class="tblUploadSection" style="width: 94% !important; margin: 10px auto; line-height: 30px;">
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="DropDownList1"  Style="margin-top:5px;" runat="server" CssClass="DropdownList">
    ...
    <div class="brdr" style="margin-top: 5px;">
        <div class="blockheader" style="margin: 0px 0px -3px auto;">
            <p style="padding-top: 3px; color: rgb(68, 68, 68);">
                <span>Search Uploaded Documents</span>
            </p>
        </div>
        <div  class="radius mrgnTp4 pdng2" style="padding-left: 4px;">
        <table style="width: 90%;">
            ...
            <tr>
                ...
                <td colspan="2">
                    <span class="fltrt" style="margin-right: 30px; margin-top: 5px;">

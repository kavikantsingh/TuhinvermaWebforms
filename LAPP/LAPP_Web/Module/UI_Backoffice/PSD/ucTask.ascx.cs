...
using LAPP.ENTITY.Enumerations;
    ...
    public partial class NVBMT_WebProject_Modules_IndiVidual_ucTask : System.Web.UI.UserControl
    {
        #region ClassMembers
        ...
        private string Validate_ControlsEdit()
        {
            ...
            try
            {
                ...
                //validateMsg += ValidationHelper.IsRequired(chkDateCompletedEdit.Text, "<li>Please enter check Date completed.</li>");
        ...
        //    lstLAPP_application_status = objLAPP_application_statusBAL.LAPP_application_status_get_by_Status_Type_Id((int)eTabStatusType.Task);

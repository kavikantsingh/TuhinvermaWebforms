...
public partial class Module_UI_Backoffice_PSD_HearingFileDocAssign : System.Web.UI.UserControl
{
    ...
    protected void btnHerinF1_Click(object sender, EventArgs e)
    {
        dvDocument.Visible = true;
    }
    protected void lnkHearignFile_Click(object sender, EventArgs e)
    {
        trhearingfile.Visible = true;
        trStatic1.Visible = false;
    }
    protected void btnClose_Click(object sender, EventArgs e)
    {
        trhearingfile.Visible = false;
        trStatic1.Visible = true;
    }

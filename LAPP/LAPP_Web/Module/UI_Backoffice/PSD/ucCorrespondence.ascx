<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucCorrespondence.ascx.cs" Inherits="Module_UI_Backoffice_PSD_ucCorrespondence" %>
<div class="" style="padding-top: 20px; padding-top: 20px">
        ...
        <div id="divAddPanelCorrespodence" visible="false" runat="server" class="brdr radius mrgnTp4 pdng2">
            <table class="tblAssign form-table" style="margin: 20px auto;">
                                ...
                                <table class="tblAssign form-table" style="margin: 20px auto 20px 80px;width: 91%;">
                                    <tr>

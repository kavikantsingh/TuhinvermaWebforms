<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucManualNew.ascx.cs"
    Inherits="ucManualNew" %>
<div class=" clearfix">
                    ...
                    <tr>
                        ...
                        <td colspan="3" style="vertical-align: middle;">
                            <asp:DropDownList Style="width: 184px !important;" ID="ddlCommands1"
                                ...
                                <asp:ListItem Value="0">Print Licenses</asp:ListItem>
                                <asp:ListItem Value="1">Re-Print Licenses</asp:ListItem>
                                <asp:ListItem Value="2">Mark License as Printed</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                    </tr>
                </tbody>
    ...
    <div class="gridUpperDiv">
        <h3 class="fltlt" style="float: left;">Manual Commands</h3>

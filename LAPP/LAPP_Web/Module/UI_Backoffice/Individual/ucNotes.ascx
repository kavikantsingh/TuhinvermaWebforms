            ...
            <div>
                <table style="width: 65%;">
                    ...
                    <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtDocumenName" Style=" margin-top:5px; width:170px;" runat="server"></asp:TextBox>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <asp:DropDownList ID="ddlDocumentType" style="margin-top:5px; width:170px !important;"  AutoPostBack="true" runat="server" CssClass="inputTextbox">
                    ...
                    <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:FileUpload style="margin-top:5px;" ID="FUDocument" runat="server" />
                                                                    </td>
                                                                    <td colspan="3">

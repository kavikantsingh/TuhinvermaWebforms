...
<div class="clear textBoxAlign" style="padding-bottom: 40px;">
    ...
    <div>
        <div class="clear textBoxAlign">
            ...
            <div>
        <div style="width: 75%; float: left; min-height: 170px;">
             ...
             <table style="width: 99%; margin: 0px auto;">
                <tr>
                    ...
                    <td colspan="3">
                        <asp:TextBox CssClass="inputTextbox " autocomplete="off" Text="Lake" ID="txtOthername1"
                            runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="3">
                        <asp:TextBox CssClass="inputTextbox " autocomplete="off" Text="Manore" ID="txtOthername2"
                            runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="3">
                        <asp:TextBox CssClass="inputTextbox " autocomplete="off" ID="txtOthername3" Text="Adams"
                            runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="3">
                        <asp:TextBox CssClass="inputTextbox " autocomplete="off" ID="txtOthername4" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td align="right">
                    ...
                    <td>
                        <asp:DropDownList ID="ddlState" CssClass="Dropdownlist" runat="server">
                            <asp:ListItem Value="-1">Select</asp:ListItem>
        ...
        <div style="float: right; width: 24%; min-height: 170px;">
            <div>
                <asp:CheckBoxList ID="CheckBoxList1" runat="server">
                    <asp:ListItem Value="1">No Payment</asp:ListItem>
                    <asp:ListItem Value="2">No Passport Photo</asp:ListItem>
                    <asp:ListItem Value="3">No Photo Id</asp:ListItem>
                    <asp:ListItem Value="4">1000 Hours Paid Massage</asp:ListItem>
                    <asp:ListItem Value="5">1750 Hours Paid Massage</asp:ListItem>
                    <asp:ListItem Value="6">Valid Permit</asp:ListItem>
                    <asp:ListItem Value="7">100 Hours in Single School</asp:ListItem>
                    <asp:ListItem Value="8">250 Hours at One School</asp:ListItem>
                    <asp:ListItem Value="9">School in Business</asp:ListItem>
                    <asp:ListItem Value="10">500 Hours at approved Schools</asp:ListItem>
                </asp:CheckBoxList>
            </div>
        </div>
    </div>

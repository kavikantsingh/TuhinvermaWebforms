<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucBoardPacket.ascx.cs"
    Inherits="NVBMT_WebProject.Modules.IndiVidual.ucBoardPacket" %>
<style>
    .btnboardpacket
    {
        text-align: center;
...
<div class="btnboardpacket">
    <asp:Button ID="btnSavePersonal" CssClass="buttonGreen medium" runat="server" Text="Print Board Packet" /></div>

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucESDCallSheet.ascx.cs" Inherits="Module_UI_Backoffice_ESD_ucESDCallSheet" %>
<%@ Register Src="~/Module/UI_Backoffice/ESD/SchoolWorkFlow/ucSchoolApplication.ascx" TagName="ucSchoolApplication"  TagPrefix="uc7" %>
<style>
...
<asp:UpdatePanel runat="server" ID="upPnlCertificateApp">
            ...
            <div>
                <div class="divNewApplicationAddu">
                    <span style="float: left; margin-right: 10px;">
                        <h4>ESD Call Sheet</h4>
                    </span>
                    <span style="float: right; margin-right: 10px;">
                        <asp:LinkButton ID="LinkButton1" CssClass="hyperlink" Visible="false" runat="server" OnClick="backCalender_Click">Back to Calendar</asp:LinkButton>
                    </span>
                </div>
            </div>
            <div class="clear">
            ...
            document.getElementById("programmaticPopup").style.display = "none";
                ...
                <div id="scheduler_here" runat="server" class="dhx_cal_container_ dhx_scheduler_week_" style="width:100%;height:50px;">
                  ...
                  <div id="divCalenderpnl"  runat="server">
                    <asp:Calendar ID="Calendar1" runat="server" Width="100%" CssClass="CallListCalender" OnDayRender="calEvent_DayRender"
                        SelectionMode="Day"
                        ShowGridLines="True"
    ...
    <TitleStyle CssClass="CallListCalendertitle" />
                        <TodayDayStyle BackColor="#178FE5" ForeColor="White" />
            ...
            <div class="gvDivUpr" id="divCallList" runat="server" visible="false" style="margin-top: 10px;">
                <table class="index  grid" cellspacing="0" cellpadding="5" id="gvNewApplication"
                    ...
                    <tbody>
                        <tr>
                            <th>
                                <asp:CheckBox ID="chkESDSelectAll" AutoPostBack="true" OnCheckedChanged="chkESD1SelectAll_CheckedChanged" runat="server" /></th>
                            <th scope="col" style="text-decoration: underline;">
                                <a href="javascript:void();" style="color: #fff;">Type</a>
                            </th>
                             <th scope="col" style="text-decoration: underline;">
                                <a href="javascript:void();" style="color: #fff;">School ID</a>
                            </th>
                            
                            <th scope="col" style="text-decoration: underline;">
                                <a href="javascript:void();" style="color: #fff;">School Name</a>
                            </th>
                            <th scope="col" style="text-decoration: underline;">
                                <a href="javascript:void();" style="color: #fff;">Submitted On</a>
                            </th>
                            <th scope="col" style="text-decoration: underline;">
                                <a href="javascript:void();" style="color: #fff;">ESD Meeting Date</a>
                            </th>
                            <th scope="col" style="text-decoration: underline;">
                                <a href="javascript:void();" style="color: #fff;">Proposed Decision</a>
                            </th>
                        ...
                        <tr id="trGridRowStatus1" runat="server">
                            <td>
                                <asp:CheckBox ID="chkESD1" runat="server" /></td>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlSCLApp" runat="server">
                                    <asp:ListItem>Select</asp:ListItem>
                                    <asp:ListItem>Approved</asp:ListItem>
                                    <asp:ListItem>Approved with Notes</asp:ListItem>
                                    <asp:ListItem>Corrective Action</asp:ListItem>
                                    <asp:ListItem>Legal</asp:ListItem>
                                </asp:DropDownList>
                               
                            </td>
                            <td>
                                <asp:Button ID="btnSCLApp" CssClass="buttonGreen small" runat="server" Text="Send" /></td>
                        </tr>
                        <tr>
                            <td>
                                <asp:CheckBox ID="chkESD2" runat="server" /></td>
                            <td>Staff</td>
                            <td>SCH002
                            </td>
                            ...
                            <td><asp:DropDownList ID="ddlSCLStaff" runat="server">
                                    <asp:ListItem>Select</asp:ListItem>
                                    <asp:ListItem>Approved</asp:ListItem>
                                    <asp:ListItem>Approved with Notes</asp:ListItem>
                                    <asp:ListItem>Corrective Action</asp:ListItem>
                            ...
                            <td><asp:Button ID="btnSCLStaff" CssClass="buttonGreen small" runat="server" Text="Send" /></td>
                        </tr>
                        <tr id="grdCreatDef" runat="server">
                            <td>
                                <asp:CheckBox ID="chkESD3" runat="server" /></td>
                            ...
                            <td><asp:DropDownList ID="ddlSCLAdd" runat="server">
                                    <asp:ListItem>Select</asp:ListItem>
                                    <asp:ListItem>Approved</asp:ListItem>
                                    <asp:ListItem>Approved with Notes</asp:ListItem>
                                    <asp:ListItem>Corrective Action</asp:ListItem>
                            ...
                            <td><asp:Button ID="btnCreateDeficiency" OnClick="btnCreateDeficiency_Click" CssClass="buttonGreen small" runat="server"
                                                             Text="Send" /></td>
                        </tr>
                        <tr id="trDificency" runat="server" visible="false">
                                <td colspan="8">
                                    <div class="clear">
                                    </div>
                                    <div class="toolBar">
                                        <table>
                                            <tr>
                                                <td></td>
                                                <td style="width: 184px;">School Name/Address</td>
                                                <td style="width: 82px; padding-left: 45px;">
                                                    SCH003
                                                </td>
                                                ...
                                                <td style="width: 85px;">1/20/2016</td>
                                                <td align="center" valign="middle" style="width: 222px;">Corrective Action</td>
                                                <td></td>
                                            </tr>
                                        </table>
                                    </div>
                                    <div class="clear">
                                      ...
                                      <uc7:ucSchoolApplication ID="ucSchoolApplication1" runat="server" />
                                </td>
                            </tr>
                        <tr runat="server" visible="false" id="dvDificency">
                                    <td colspan="8">
                                        <div class="toolBar" style="padding: 4px;"  runat="server">
                                                <%--<div style="float: left;">
                                                    <div id="pnlschooninfo">
                                                        <table class="">
                                                            <tbody>
                                                                <tr>
                                                                    <td class="">
                                                                        <span class="">
                                                                            <input type="submit" value="Assign To" id="btnsigninfo" class="buttonGreen medium">
                                                                        </span>
                                                ...
                                                <span class="fltrt"><%--<span class="AfterApproved">
                                                    <asp:Button ID="Button121" CssClass="buttonGreen medium" runat="server" Text="Save as PDF" />
                                                    <asp:Button ID="Button122" ValidationGroup="vgAffidavit" CssClass="buttonGreen medium"
                                                        runat="server"  Text="Confirm and Pre-Approve" CausesValidation="true" />
                                                    <asp:Button ID="Button123" ClientIDMode="Static" CssClass="buttonGreen medium"
                                                        runat="server" Text="Confirm and Approve" Enabled="false" CausesValidation="true" /></span>--%>
                                                    <asp:LinkButton ID="lnkcloseSCLinfo" style="margin: 0px; float: right;" CssClass="secondary medium bottom buttonalignment"
                                                        runat="server" OnClick="lnkcloseSCLinfo_Click" >Close Application</asp:LinkButton></span>
                                            </div>
                                    </td>
                                </tr>
                        <tr>
                            <td>
                                <asp:CheckBox ID="chkESD4" runat="server" /></td>
                            <td>Approval/Programs</td>
                            <td>SCH004
                            </td>
                            ...
                            <td><asp:DropDownList ID="ddlAPPProg" runat="server">
                                    <asp:ListItem>Select</asp:ListItem>
                                    <asp:ListItem>Approved</asp:ListItem>
                                    <asp:ListItem>Approved with Notes</asp:ListItem>
                                    <asp:ListItem>Corrective Action</asp:ListItem>
                            ...
                            <td><asp:Button ID="btnMTC" CssClass="buttonGreen small" runat="server"
                                                             Text="Send" /></td>
                        </tr>
                        <tr>
                            <td>
                                <asp:CheckBox ID="chkESD5" runat="server" /></td>
                            <td>Graduate Numbers</td>
                            <td>SCH005
                            </td>
                            ...
                            <td><asp:DropDownList ID="ddlGraNum" runat="server">
                                    <asp:ListItem>Select</asp:ListItem>
                                    <asp:ListItem>Approved</asp:ListItem>
                                    <asp:ListItem>Approved with Notes</asp:ListItem>
                                    <asp:ListItem>Corrective Action</asp:ListItem>
                            ...
                            <td><asp:Button ID="btnGraNum" CssClass="buttonGreen small" runat="server" Text="Send" /></td>
                        </tr>
                        <tr>
                            <td>
                                <asp:CheckBox ID="chkESD6" runat="server" /></td>
                            ...
                            <td><asp:DropDownList ID="ddlCOUCat" runat="server">
                                    <asp:ListItem>Select</asp:ListItem>
                                    <asp:ListItem>Approved</asp:ListItem>
                                    <asp:ListItem>Approved with Notes</asp:ListItem>
                                    <asp:ListItem>Corrective Action</asp:ListItem>
                            ...
                            <td><asp:Button ID="btnCOUCat" CssClass="buttonGreen small" runat="server" Text="Send" /></td>
                        </tr>
                        <tr>
                            <td>
                                <asp:CheckBox ID="chkESD7" runat="server" /></td>
                            <td>Curriculum</td>
                            <td>SCH007
                            </td>
                            ...
                            <td><asp:DropDownList ID="ddlCurr" runat="server">
                                    <asp:ListItem>Select</asp:ListItem>
                                    <asp:ListItem>Approved</asp:ListItem>
                                    <asp:ListItem>Approved with Notes</asp:ListItem>
                                    <asp:ListItem>Corrective Action</asp:ListItem>
                            ...
                            <td><asp:Button ID="btnCurr" CssClass="buttonGreen small" runat="server" Text="Send" /></td>
                        </tr>
                        <tr>
                            <td>
                                <asp:CheckBox ID="chkESD8" runat="server" /></td>
                            <td>Transcript</td>
                            <td>SCH008
                            </td>
                            ...
                            <td><asp:DropDownList ID="ddlTrans" runat="server">
                                    <asp:ListItem>Select</asp:ListItem>
                                    <asp:ListItem>Approved</asp:ListItem>
                                    <asp:ListItem>Approved with Notes</asp:ListItem>
                                    <asp:ListItem>Corrective Action</asp:ListItem>
                            ...
                            <td><asp:Button ID="btnTrans" CssClass="buttonGreen small" runat="server" Text="Send" /></td>
                        </tr>
                        <tr>
                            <td>
                                <asp:CheckBox ID="chkESD9" runat="server" /></td>
                            <td>Enrollment Agreement</td>
                            <td>SCH009
                            </td>
                            ...
                            <td><asp:DropDownList ID="ddlEnrAgg" runat="server">
                                    <asp:ListItem>Select</asp:ListItem>
                                    <asp:ListItem>Approved</asp:ListItem>
                                    <asp:ListItem>Approved with Notes</asp:ListItem>
                                    <asp:ListItem>Corrective Action</asp:ListItem>
                            ...
                            <td><asp:Button ID="btnEnrAgg" CssClass="buttonGreen small" runat="server" Text="Send" /></td>
                        </tr>
                        <tr>
                            <td>
                                <asp:CheckBox ID="chkESD10" runat="server" /></td>
                            ...
                            <td><asp:DropDownList ID="ddlEligLis" runat="server">
                                    <asp:ListItem>Select</asp:ListItem>
                                    <asp:ListItem>Approved</asp:ListItem>
                                    <asp:ListItem>Approved with Notes</asp:ListItem>
                                    <asp:ListItem>Corrective Action</asp:ListItem>
                            ...
                            <td><asp:Button ID="btnEligLis" CssClass="buttonGreen small" runat="server" Text="Send" /></td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="toolBar">
                <p style="text-align: center;">
                    Move selected to ESD Meeting Date on &nbsp;
                    <asp:TextBox ID="txtdate" CssClass="calender" placeholder="MM/DD/YYYY" runat="server"></asp:TextBox>
                    <asp:Button ID="btnSubmit" CssClass="buttonGreen medium" runat="server"
                                                             Text="Submit" />
                </p>
            </div>
        </div>

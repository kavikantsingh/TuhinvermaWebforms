<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucSchoolWorkflowSCLNameAdd.ascx.cs" Inherits="Module_UI_Backoffice_ESD_SchoolWorkFlow_ucSchoolWorkflowSCLNameAdd" %>
<script>
                                            ...
                                            <div class="menu-w-licensure-container">
                                                <div id="nav_menu-32" class="widget widget_nav_menu">
                                                    <ul id="menu-w-licensure" class="menu Act ulwidth">
                                                        ...
                                                        <li runat="server" clientidmode="Static" class="actived" id="liMassageTherapistApplication">
                                                            ...
                                                            <span class="spnStatusImage statusimgalgn">
                                                                <asp:ImageButton ID="imgMassageTherapistApplication" Width="20px" Height="20px" runat="server"
                                                                    ToolTip="Completed" ImageUrl="~/App_Themes/Theme1/images/button_cross.png" OnClick="btnMassageTherapistApplication_Click" /></span>
                                                        </li>

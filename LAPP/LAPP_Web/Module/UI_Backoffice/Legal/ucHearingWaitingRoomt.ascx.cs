...
public partial class Module_UI_Backoffice_Legal_ucHearingWaitingRoomt : System.Web.UI.UserControl
{
    ...
    {
        Response.Redirect("~/LAPP_UI_Backoffice/Legal/HearingSchedule.aspx");
    }
    protected void btnmove2_Click(object sender, EventArgs e)
    {
        Response.Redirect("~/LAPP_UI_Backoffice/Legal/HearingSchedule.aspx");
    }
    protected void btnfootermove_Click(object sender, EventArgs e)
    {
        Response.Redirect("~/LAPP_UI_Backoffice/Legal/HearingSchedule.aspx");
    }
}
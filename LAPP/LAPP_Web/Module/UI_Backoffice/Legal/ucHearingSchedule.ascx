<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucHearingSchedule.ascx.cs" Inherits="Module_UI_Backoffice_Legal_ucHearingSchedule" %>
<style>
    ...
    <TitleStyle CssClass="CallListCalendertitle" />
                ...
                <table class="index  grid" cellspacing="0" cellpadding="5" id="gvNewApplication"
                    ...
                    <tbody>
                        <tr>
                            ...
                            <th scope="col" style="text-decoration: underline;">
                                <a href="javascript:void();" style="color: #fff;">Attorney Name</a>
                            </th>

                            <th scope="col" style="text-decoration: underline;">
                                <a href="javascript:void();" style="color: #fff;">Type of Hearing</a>
                            </th>
                            <th scope="col" style="text-decoration: underline;">Pass Code</th>
                            <th scope="col" style="text-decoration: underline;">Decision</th>
                             <th scope="col" style="text-decoration: underline;">Discipline Period</th>
                            <th scope="col" style="text-decoration: underline;">Probationary Terms</th>
                             <th scope="col" style="text-decoration: underline;">Action</th>
                        </tr>
                        <tr id="trGridRowStatus1" runat="server">
                            ...
                            <td>
                                <asp:Button ID="btnSend1" OnClick="btnSend1_Click" runat="server" CssClass="buttonGreen medium" Text="Send" /></td>
                        </tr>
                        ...
                        <tr>
                           ...
                           <td></td>
                            ...
                            <td><asp:Button ID="Button3" runat="server" CssClass="buttonGreen medium" Text="Send" /></td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="toolBar">
                <p style="text-align: center;">
                    ...
                    <asp:Button ID="btnsubmit" class="buttonGreen medium" runat="server" Text="Submit" />
                    &nbsp; &nbsp;
                    Additional Hearing : &nbsp;
                    <asp:TextBox ID="txtAddHering" CssClass="calender" placeholder="MM/DD/YYYY" runat="server"></asp:TextBox>
                    <asp:Button ID="Button2" class="buttonGreen medium" runat="server" Text="Submit" />
                </p>
            </div>
        </div>
    </ContentTemplate>

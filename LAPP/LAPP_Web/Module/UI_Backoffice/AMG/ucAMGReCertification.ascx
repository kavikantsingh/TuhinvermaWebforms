<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucAMGReCertification.ascx.cs" Inherits="Module_UI_Backoffice_AMG_ucAMGReCertification" %>
                                                            ...
                                                            <div class="menu-w-licensure-container">
                                                                <div id="nav_menu-32" class="widget widget_nav_menu">
                                                                    <ul id="menu-w-licensure" class="menu Act ulwidth">
                                                                        <li runat="server" class="actived" clientidmode="Static" id="liSection1">
                                                            ...
                                                            <asp:Panel ID="pnlApprovedPersonalTab" runat="server">
                                                                <div>
                                                                    ...
                                                                    <div class="toolBar AfterApproved" style="padding: 4px; margin: 4px;">
                                                                        <span class="fltrt">
                                                                            <asp:ImageButton ID="ImageButton11"  ToolTip="Undeficient"
                                                        ...
                                                        <ContentTemplate>
                                                            <asp:Panel ID="pnlApprovedSection5" runat="server">
                                                                <div>
                                                                    ...
                                                                    <div class="toolBar AfterApproved" style="padding: 4px; margin: 4px;">
                                                                        <span class="fltrt">
                                                                            <asp:ImageButton ID="ImageButton4"  ToolTip="Undeficient"
                                                                                runat="server" ImageUrl="http://staff.nvbmt.inlumon.com/App_Themes/Theme1/images/icon_weight_lrg_green.png" />
                                                                            ...
                                                                            <tr>
                                                                                <td colspan="3">
                                                                                    <div id="divhist2" runat="server" visible="false">
                                                                                        ...
                                                                                        <asp:TextBox ID="TextBox6" CssClass="txtQestion2 aspNetDisabled" disabled TextMode="MultiLine" Style="width: 656px; line-height: 18px; height: 60px;"
                                                                                            runat="server"></asp:TextBox>
                                                                                        <div class="histdiv">
                                                                                            <table class="tblApplReqForm5" style="width: 100%;">
                                                                                                <tr>
                                                                            ...
                                                                            <tr>
                                                                                <td colspan="3">
                                                                                    <div id="divhist3" runat="server" visible="false">
                                                                                        ...
                                                                                        <asp:TextBox ID="TextBox17" CssClass="txtQestion3 aspNetDisabled" disabled TextMode="MultiLine" Style="width: 656px; line-height: 18px; height: 60px;"
                                                                                            runat="server"></asp:TextBox>
                                                                                        <div class="histdiv">
                                                                                            <table class="tblApplReqForm5" style="width: 100%;">
                                                                                                <tr>
                                                                            ...
                                                                            <tr>
                                                                                <td colspan="3">
                                                                                    <div id="divhist4" runat="server" visible="false">
                                                                                        ...
                                                                                        <asp:TextBox ID="TextBox9" CssClass="txtQestion4 aspNetDisabled" disabled TextMode="MultiLine" Style="width: 656px; line-height: 18px; height: 60px;"
                                                                                            runat="server"></asp:TextBox>
                                                                                        <div class="histdiv">
                                                                                            <table class="tblApplReqForm5" style="width: 100%;">
                                                                                                <tr>
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td align="center">
                                                                                                        <span class="fltlft">
                                                                                                            <asp:Button ID="Button12" CssClass="buttonGreen small" runat="server" Text="Upload Document"
                                                                            ...
                                                                            <tr>
                                                                                <td colspan="3">
                                                                                    <div id="divhist6" runat="server" visible="false">
                                                                                        ...
                                                                                        <asp:TextBox ID="TextBox11" CssClass="txtQestion6 aspNetDisabled" disabled TextMode="MultiLine" Style="width: 656px; line-height: 18px; height: 60px;"
                                                                                            runat="server"></asp:TextBox>
                                                                                        <div class="histdiv">
                                                                                            <table class="tblApplReqForm5" style="width: 100%;">
                                                                                                <tr>
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td align="center">
                                                                                                        <span class="fltlft">
                                                                                                            <asp:Button ID="Button14" CssClass="buttonGreen small" runat="server" Text="Upload Document"
                                                                ...
                                                                <table style="width: 100%;">
                                                                    <tr>
                                                                        ...
                                                                        <td align="right" style="width: 50px; vertical-align: middle;" class="cursorpointer">
                                                                            <asp:CheckBox Text="initial" Checked="true" ID="AffQ1" AutoPostBack="true" OnCheckedChanged="chkAffidavit_OnCheckedChanged"
                                                                                runat="server" />
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td align="right" style="vertical-align: middle;" class="cursorpointer">
                                                                            <asp:CheckBox Text="initial" Checked="true" ID="AffQ2" AutoPostBack="true" OnCheckedChanged="chkAffidavit_OnCheckedChanged"
                                                                                runat="server" />
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td align="right" style="vertical-align: middle;" class="cursorpointer">
                                                                            <asp:CheckBox Text="initial" Checked="true" ID="AffQ3" AutoPostBack="true" OnCheckedChanged="chkAffidavit_OnCheckedChanged"
                                                                                runat="server" />
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td align="right" style="vertical-align: middle;" class="cursorpointer">
                                                                            <asp:CheckBox Text="initial" ID="AffQ4" AutoPostBack="true" OnCheckedChanged="chkAffidavit_OnCheckedChanged"
                                                                                runat="server" />
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td align="right" style="vertical-align: middle;" class="cursorpointer">
                                                                            <asp:CheckBox Text="initial" Checked="true" ID="AffQ5" AutoPostBack="true" OnCheckedChanged="chkAffidavit_OnCheckedChanged"
                                                                                runat="server" />
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td align="right" style="vertical-align: middle;" class="cursorpointer">
                                                                            <asp:CheckBox Text="initial" Checked="true" ID="AffQ6" AutoPostBack="true" OnCheckedChanged="chkAffidavit_OnCheckedChanged"
                                                                                runat="server" />
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td align="right" style="vertical-align: middle;" class="cursorpointer">
                                                                            <asp:CheckBox Text="initial" ID="AffQ7" AutoPostBack="true" OnCheckedChanged="chkAffidavit_OnCheckedChanged"
                                                                                runat="server" />
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td align="right" style="vertical-align: middle;" class="cursorpointer">
                                                                            <asp:CheckBox Checked="true" Text="initial" ID="AffQ8" AutoPostBack="true" OnCheckedChanged="chkAffidavit_OnCheckedChanged"
                                                                                runat="server" />
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td align="right" style="vertical-align: middle;" class="cursorpointer">
                                                                            <asp:CheckBox Checked="true" Text="initial" ID="AffQ9" AutoPostBack="true" OnCheckedChanged="chkAffidavit_OnCheckedChanged"
                                                                                runat="server" />
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                        ...
                                                        <ContentTemplate>
                                                            <asp:Panel ID="pnlApprovedAffidavit" runat="server">
                                                                <div>
                                                                    ...
                                                                    <fieldset class="flsNewApplReqForm flsAffidavit" style="display:none;">
                                                                        <p>

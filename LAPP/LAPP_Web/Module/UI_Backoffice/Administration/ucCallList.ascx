<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucCallList.ascx.cs" Inherits="Module_UI_Backoffice_Administration_ucCallList" %>
<style>
...
<asp:UpdatePanel runat="server" ID="upPnlCertificateApp">
            ...
            document.getElementById("programmaticPopup").style.display = "none";
                ...
                <div id="scheduler_here" runat="server" class="dhx_cal_container_ dhx_scheduler_week_" style="width:100%;height:50px;">
                  ...
                  <div id="divCalenderpnl"  runat="server">
                    <asp:Calendar ID="Calendar1" runat="server" CssClass="CallListCalender" OnDayRender="calEvent_DayRender"
                        SelectionMode="Day"
                        ShowGridLines="True"
    ...
    <TitleStyle CssClass="CallListCalendertitle" />
                ...
                <table class="index  grid" cellspacing="0" cellpadding="5" id="gvNewApplication"
                    ...
                    <tbody>
                        <tr>
                            ...
                            <th scope="col" style="text-decoration: underline;">
                                <a href="javascript:void();" style="color: #fff;">Subsequent PSD Meeting Date</a>
                            </th>
                            <th scope="col" style="text-decoration: underline;">
                        ...
                        <tr id="trGridRowStatus1" runat="server">
                            ...
                            <td>
                                <asp:LinkButton ID="lnkDate1" runat="server" OnClick="lnkDate1_Click">01/28/2016,</asp:LinkButton>
                                <asp:LinkButton ID="LinkButton2" runat="server" OnClick="lnkDate1_Click">01/20/2016</asp:LinkButton>                               
                            </td>
                            <td align="center">
                            <asp:CheckBox ID="CheckBox1" runat="server" />
                            </td>
                            <td>
                                <asp:Button ID="Button1" runat="server" CssClass="secondary small" Text="Notes" /></td>
                        </tr>
                                ...
                                <div class="toolBar">
                                    <table style="width: 100%; table-layout: fixed;">
                                        <tr>
                                            ...
                                            <td style="width: 101px; font-weight: bold; padding: 0px;">01/28/2016, 01/20/2016
                                            </td>
            ...
            <br />
            <div class="toolBar">
                <p style="text-align: center; float: left; margin-left: 6%;">
                    Reschedule PSD Meeting Date : &nbsp;
                    ...
                    &nbsp; &nbsp;
                    Additional PSD Meeting Date : &nbsp;
                    <asp:TextBox ID="TextBox2" CssClass="calender" placeholder="MM/DD/YYYY" runat="server"></asp:TextBox>

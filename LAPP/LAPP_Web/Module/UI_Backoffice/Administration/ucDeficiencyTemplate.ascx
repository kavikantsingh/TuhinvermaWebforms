<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucDeficiencyTemplate.ascx.cs" Inherits="Module_UI_Backoffice_Administration_DeficiencyTemplate" %>
...
<asp:UpdatePanel ID="uppnl" runat="server">
    ...
    <ContentTemplate>
        <div style="padding: 10px 0px 25px;" class="divDocumentType divaddnew" id="divAddNewbutton"
            runat="server">
            <h4 style="float: left;">Deficiency Template 
            </h4>
            ...
            <div style="padding: 25px 0px 12px 0px;">
                <table style="width: 100%; margin: 0px auto;">
                    ...
                    <tr>
                        <td align="right">
                            <label class="input-label required">
                                Deficiency Template Name :</label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td align="right">
                            <label class="input-label ">
                                Deficiency Template Subject :</label>
                        </td>
                        <td colspan="3">
                            <asp:TextBox CssClass="inputTextbox" Style="width: 542px; height: 60px;" ID="txtsub"
                    ...
                    <tr>
                        <td align="right">
                            <label class="input-label ">
                                Deficiency Template Message :</label>
                        </td>
                        <td>
                            <asp:TextBox CssClass="inputTextbox" Style="width: 542px; height: 60px;" ID="txtmsg"
                                runat="server" TextMode="MultiLine"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
            ...
            <div style="margin-top: 3px;">
                <asp:GridView ID="gvDeficiency" ClientIDMode="Static" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                                ...
                                <div class="divGridEdit">
                                    <table style="margin: 5px auto; width: 75%;" class="tblParentNewApplReqForm tblLicensureInformation wthtop20">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                <asp:TextBox CssClass="inputTextbox" Style="width: 542px; height: 60px;" ID="txtsubEdit"
                                                    runat="server" TextMode="MultiLine"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox CssClass="inputTextbox" Style="width: 542px; height: 60px;" ID="txtmsgEdit"
                                                    runat="server" TextMode="MultiLine"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                        ...
                        <asp:TemplateField HeaderText="Deficiency Template Name">
                            <ItemStyle Width="15%" />
                            <ItemTemplate>
                                <%#Eval("Deficiency_Template_Name")%>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Action" HeaderStyle-CssClass="alincenter">
                            ...
                            <ItemTemplate>
                                <asp:ImageButton ID="imgbtnEdit" CssClass="imgDelete" CommandArgument='<%# Eval("Deficiency_Template_ID") %>' Visible='<%#Eval("Is_Editable")%>'
                                ...
                                <asp:ImageButton ID="imgBtnDelete" CssClass="imgDelete" runat="server" ToolTip="Delete" Visible='<%#Eval("Is_Editable")%>'
                                    CommandArgument='<%# Eval("Deficiency_Template_ID") %>' ImageUrl="~/App_Themes/Theme1/images/delete.png"

<%@ Page Title="" Language="C#" MasterPageFile="~/LAPP_UI_School/MasterPage/SchoolOwnAdminInstructor.master" AutoEventWireup="true" CodeFile="SchoolOwnAdminInstructor.aspx.cs" Inherits="LAPP_UI_School_UI_SchoolOwnAdminInstructor" %>
<%@ Register Src="~/Module/UI_School/ucOwnAdminInstructorDashboard.ascx" TagName="ucOwnAdminInstructorDashboard"
    TagPrefix="uc1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        <uc1:ucOwnAdminInstructorDashboard ID="ucMemberDashboard1" runat="server" />
    </div>
    <style>
        .error {

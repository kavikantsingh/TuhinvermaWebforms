<%@ Page Title="" Language="C#" MasterPageFile="~/LAPP_UI_School/MasterPage/SchoolAdminInstructor.master" AutoEventWireup="true" CodeFile="SchoolAdminiInstructorDashboard.aspx.cs" Inherits="LAPP_UI_School_UI_SchoolAdminiInstructorDashboard" %>

<%@ Register Src="~/Module/UI_School/ucAdminInstructorDashboard.ascx" TagName="ucAdminInstructorDashboard"
    TagPrefix="uc1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        <uc1:ucAdminInstructorDashboard ID="ucMemberDashboard1" runat="server" />
    </div>
    <style>
        .error {

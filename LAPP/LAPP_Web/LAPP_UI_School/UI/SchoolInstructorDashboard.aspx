<%@ Page Title="" Language="C#" MasterPageFile="~/LAPP_UI_School/MasterPage/SchoolInstructor.master" AutoEventWireup="true" CodeFile="SchoolInstructorDashboard.aspx.cs" Inherits="LAPP_UI_School_UI_SchoolInstructorDashboard" %>

<%@ Register Src="~/Module/UI_School/ucInstructorDashboard.ascx" TagName="ucInstructorDashboard"
    TagPrefix="uc1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        <uc1:ucInstructorDashboard ID="ucMemberDashboard1" runat="server" />
    </div>
    <style>
        .error {

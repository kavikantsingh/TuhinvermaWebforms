<%@ Page Title="Dashboard : California Massage Therapy Council" Language="C#"
    MasterPageFile="~/LAPP_UI_School/MasterPage/SchoolMain.master" AutoEventWireup="true" CodeFile="SchoolDashboard.aspx.cs"
    Inherits="NVBMT_Public.UI.Dashboard" %>

<%@ Register Src="~/Module/UI_School/ucMemberDashboard.ascx" TagName="ucMemberDashboard"
    TagPrefix="uc1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        <uc1:ucMemberDashboard ID="ucMemberDashboard1" runat="server" />
    </div>
    <style>
        .error {

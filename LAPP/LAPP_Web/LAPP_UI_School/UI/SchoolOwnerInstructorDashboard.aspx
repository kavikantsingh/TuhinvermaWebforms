<%@ Page Title="" Language="C#" MasterPageFile="~/LAPP_UI_School/MasterPage/SchoolOwnerInstructor.master" AutoEventWireup="true" CodeFile="SchoolOwnerInstructorDashboard.aspx.cs" Inherits="LAPP_UI_School_UI_SchoolOwnerInstructorDashboard" %>

<%@ Register Src="~/Module/UI_School/ucOwnerInstructorDashboard.ascx" TagName="ucOwnerInstructorDashboard"
    TagPrefix="uc1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        <uc1:ucOwnerInstructorDashboard ID="ucMemberDashboard1" runat="server" />
    </div>
    <style>
        .error {

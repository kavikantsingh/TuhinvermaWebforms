<%@ Page Title="" Language="C#" MasterPageFile="~/LAPP_UI_School/MasterPage/SchoolAdministrator.master" AutoEventWireup="true" CodeFile="SchoolAdministratorDashboard.aspx.cs" Inherits="LAPP_UI_School_UI_SchoolAdministratorDashboard" %>

<%@ Register Src="~/Module/UI_School/ucSchoolAdministratorDashboard.ascx" TagName="ucSchoolAdministratorDashboard"
    TagPrefix="uc1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        <uc1:ucSchoolAdministratorDashboard ID="ucMemberDashboard1" runat="server" />
    </div>
    <style>
        .error {

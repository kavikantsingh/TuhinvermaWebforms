<%@ Page Title="" Language="C#" MasterPageFile="~/LAPP_UI_School/MasterPage/SchoolContactMain.master" AutoEventWireup="true" CodeFile="SchoolContactDashboard.aspx.cs" Inherits="LAPP_UI_School_UI_SchoolContactDashboard" %>

<%@ Register Src="~/Module/UI_School/ucContactDashboard.ascx" TagName="ucContactDashboard"
    TagPrefix="uc1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        <uc1:ucContactDashboard ID="ucMemberDashboard1" runat="server" />
    </div>
    <style>
        .error {

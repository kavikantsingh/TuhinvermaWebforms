<%@ Page Title="" Language="C#" MasterPageFile="~/LAPP_UI_School/MasterPage/SchoolMain.master" AutoEventWireup="true" CodeFile="schoolpubinstDashboard.aspx.cs" Inherits="LAPP_UI_School_UI_schoolpubinstDashboard" %>
<%@ Register Src="~/Module/UI_School/ucschoolpubinstDashboard.ascx" TagName="ucschoolpubinstDashboard"
    TagPrefix="uc1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div>
        <uc1:ucschoolpubinstDashboard ID="ucschoolpubinstDashboard" runat="server" />
    </div>
    <style>
        .error {

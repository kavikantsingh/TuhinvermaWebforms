<%@ Page Title="Dashboard : California Massage Therapy Council" Language="C#" MasterPageFile="~/LAPP_UI_School/MasterPage/SchoolOwnerMain.master" 
    AutoEventWireup="true" CodeFile="SchoolOwnerDashboard.aspx.cs" Inherits="LAPP_UI_School_UI_SchoolOwnerDashboard" %>

<%@ Register Src="~/Module/UI_School/ucOwnerDashboard.ascx" TagName="ucOwnerDashboard"
    TagPrefix="uc1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        <uc1:ucOwnerDashboard ID="ucMemberDashboard1" runat="server" />
    </div>
    <style>
        .error {

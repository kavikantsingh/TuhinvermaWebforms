<%@ Page Title="" Language="C#" MasterPageFile="~/LAPP_UI_Backoffice/MasterPage/1Column.master" AutoEventWireup="true" CodeFile="HearingWaitingRoomt.aspx.cs" Inherits="LAPP_UI_Backoffice_Legal_HearingWaitingRoomt" %>
<%@ Register Src="~/Module/UI_Backoffice/Legal/ucHearingWaitingRoomt.ascx" TagPrefix="uc1" TagName="ucHearingWaitingRoomt" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MidContent" Runat="Server">
    <div class="get-started-content">
        <uc1:ucHearingWaitingRoomt runat="server" ID="ucHearingWaitingRoomt1" />
    </div>
    <script type="text/javascript">

<%@ Page Title="" Language="C#" MasterPageFile="~/LAPP_UI_Backoffice/MasterPage/1Column.master" AutoEventWireup="true" CodeFile="StaffAttorney.aspx.cs" Inherits="LAPP_UI_Backoffice_Legal_StaffAttorney" %>
<%@ Register Src="~/Module/UI_Backoffice/Legal/ucStaffAttorney.ascx" TagPrefix="uc1" TagName="ucStaffAttorney" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MidContent" Runat="Server">
     <div class="get-started-content">
        <uc1:ucStaffAttorney runat="server" ID="ucStaffAttorney1" />
    </div>
    <script type="text/javascript">

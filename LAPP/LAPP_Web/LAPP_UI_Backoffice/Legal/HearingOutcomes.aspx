<%@ Page Title="" Language="C#" MasterPageFile="~/LAPP_UI_Backoffice/MasterPage/1Column.master" AutoEventWireup="true" CodeFile="HearingOutcomes.aspx.cs" Inherits="LAPP_UI_Backoffice_Legal_HearingOutcomes" %>
<%@ Register Src="~/Module/UI_Backoffice/Legal/ucHearingOutcomes.ascx" TagPrefix="uc1" TagName="ucHearingOutcomes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MidContent" Runat="Server">
    <div class="get-started-content">
        <uc1:ucHearingOutcomes runat="server" ID="ucHearingOutcomes1" />
    </div>
    <script type="text/javascript">

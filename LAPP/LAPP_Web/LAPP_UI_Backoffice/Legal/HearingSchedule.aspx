<%@ Page Title="" Language="C#" MasterPageFile="~/LAPP_UI_Backoffice/MasterPage/1Column.master" AutoEventWireup="true" CodeFile="HearingSchedule.aspx.cs" Inherits="LAPP_UI_Backoffice_Legal_HearingSchedule" %>

<%@ Register Src="~/Module/UI_Backoffice/Legal/ucHearingSchedule.ascx" TagPrefix="uc1" TagName="ucHearingSchedule" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MidContent" Runat="Server">
    <div class="get-started-content">
        <uc1:ucHearingSchedule runat="server" ID="ucHearingSchedule1" />
    </div>
    <script type="text/javascript">

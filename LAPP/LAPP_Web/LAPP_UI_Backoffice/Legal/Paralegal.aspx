<%@ Page Title="" Language="C#" MasterPageFile="~/LAPP_UI_Backoffice/MasterPage/1Column.master" AutoEventWireup="true" CodeFile="Paralegal.aspx.cs" Inherits="LAPP_UI_Backoffice_Legal_Paralegal" %>

<%@ Register Src="~/Module/UI_Backoffice/Legal/ucParalegal.ascx" TagPrefix="uc1" TagName="ucParalegal" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MidContent" Runat="Server">
    <div class="get-started-content">
        <uc1:ucParalegal runat="server" ID="ucParalegal" />
    </div>
    <script type="text/javascript">

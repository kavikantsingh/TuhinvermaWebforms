<%@ Page Title="" Language="C#" MasterPageFile="~/LAPP_UI_Backoffice/MasterPage/1Column.master" AutoEventWireup="true" CodeFile="HearingNotes.aspx.cs" Inherits="LAPP_UI_Backoffice_ARS_HearingNotes" %>
<%@ Register Src="~/Module/UI_Backoffice/ARS/ucHearingNotes.ascx" TagName="ucARSLegal" TagPrefix="uc1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MidContent" Runat="Server">
    <div class="get-started-content">
        <uc1:ucARSLegal runat="server" ID="ucARSLegal" />
    </div>
    <script>

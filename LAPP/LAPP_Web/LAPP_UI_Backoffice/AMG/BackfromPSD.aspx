<%@ Page Title="" Language="C#" MasterPageFile="~/LAPP_UI_Backoffice/MasterPage/1Column.master" AutoEventWireup="true" CodeFile="BackfromPSD.aspx.cs" Inherits="LAPP_UI_Backoffice_AMG_BackfromPSD" %>
<%@ Register Src="~/Module/UI_Backoffice/AMG/ucBackfromPSD.ascx" TagName="ucBackfromPSD"
    TagPrefix="uc1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MidContent" runat="Server">
    <div class="get-started-content">
        <uc1:ucBackfromPSD ID="ucCertificationApplication1" runat="server" />
    </div>
    <script type="text/javascript">

<%@ Page Title="" Language="C#" MasterPageFile="~/LAPP_UI_Backoffice/MasterPage/1Column.master" AutoEventWireup="true" CodeFile="BackfromLegal.aspx.cs" Inherits="LAPP_UI_Backoffice_AMG_BackfromLegal" %>
<%@ Register Src="~/Module/UI_Backoffice/AMG/ucBackfromLegal.ascx" TagName="ucBackfromLegal"
    TagPrefix="uc1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MidContent" runat="Server">
    <div class="get-started-content">
        <uc1:ucBackfromLegal ID="ucCertificationApplication1" runat="server" />
    </div>
    <script type="text/javascript">

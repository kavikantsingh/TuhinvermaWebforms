<%@ Page Title="" Language="C#" MasterPageFile="~/LAPP_UI_Backoffice/MasterPage/1Column.master" AutoEventWireup="true" CodeFile="Audit.aspx.cs" Inherits="LAPP_UI_Backoffice_AMG_Audit" %>
<%@ Register Src="~/Module/UI_Backoffice/AMG/ucAudit.ascx" TagName="ucAudit"
    TagPrefix="uc1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MidContent" runat="Server">
    <div class="get-started-content">
        <uc1:ucAudit ID="ucCertificationApplication1" runat="server" />
    </div>
    <script type="text/javascript">

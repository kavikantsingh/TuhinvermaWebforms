<%@ Page Title="" Language="C#" MasterPageFile="~/LAPP_UI_Backoffice/MasterPage/1Column.master" AutoEventWireup="true" CodeFile="BackfromESD.aspx.cs" Inherits="LAPP_UI_Backoffice_AMG_BackfromESD" %>

<%@ Register Src="~/Module/UI_Backoffice/AMG/ucBackfromESD.ascx" TagName="ucBackfromESD"
    TagPrefix="uc1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MidContent" runat="Server">
    <div class="get-started-content">
        <uc1:ucBackfromESD ID="ucCertificationApplication1" runat="server" />
    </div>
    <script type="text/javascript">

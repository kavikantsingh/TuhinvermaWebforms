<%@ Page Title="" Language="C#" MasterPageFile="~/LAPP_UI_Backoffice/MasterPage/1Column.master" AutoEventWireup="true" CodeFile="Education.aspx.cs" Inherits="LAPP_UI_Backoffice_AMG_Education" %>
<%@ Register Src="~/Module/UI_Backoffice/AMG/ucEducation.ascx" TagName="ucEducation"
    TagPrefix="uc1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MidContent" runat="Server">
    <div class="get-started-content">
        <uc1:ucEducation ID="ucEducation1" runat="server" />
    </div>
    <script type="text/javascript">

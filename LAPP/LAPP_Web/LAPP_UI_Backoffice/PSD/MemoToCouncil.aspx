<%@ Page Title="" Language="C#" MasterPageFile="~/LAPP_UI_Backoffice/MasterPage/1Column.master" AutoEventWireup="true" CodeFile="MemoToCouncil.aspx.cs" Inherits="LAPP_UI_Backoffice_PSD_MemoToCouncil" %>
<%@ Register Src="~/Module/UI_Backoffice/PSD/ucMemoToCouncil.ascx" TagPrefix="uc1" TagName="ucMemoToCouncil" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MidContent" runat="server">
    <div class="get-started-content">
        <uc1:ucMemoToCouncil runat="server" ID="ucMemoToCouncil1" />
    </div>
    <script>

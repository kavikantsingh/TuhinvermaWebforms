<%@ Page Title="" Language="C#" MasterPageFile="~/LAPP_UI_Backoffice/MasterPage/1Column.master" AutoEventWireup="true" CodeFile="CallList.aspx.cs" Inherits="LAPP_UI_Backoffice_Administration_CallList" %>

<%@ Register Src="~/Module/UI_Backoffice/Administration/ucCallList.ascx" TagPrefix="uc1" TagName="ucCallList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MidContent" runat="Server">
    <div class="get-started-content">
        <uc1:ucCallList runat="server" ID="ucCallList" />
    </div>
    <script type="text/javascript">

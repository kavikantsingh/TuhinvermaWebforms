<%@ Page Title="" Language="C#" MasterPageFile="~/LAPP_UI_Backoffice/MasterPage/1Column.master" AutoEventWireup="true" CodeFile="CertificationApplication.aspx.cs" Inherits="LAPP_UI_Backoffice_Workflow_CertificationApplication" %>

<%@ Register Src="~/Module/UI_Backoffice/Workflow/ucCertification.ascx" TagName="ucCertificationApplication"
    TagPrefix="uc1" %>
...
<link rel="stylesheet" type="text/css" href="../../App_Themes/Theme1/css/ieAll.css" />
    ...
    <style>
        ...
        .searchBoxhidden fieldset input[type="text"], .searchBoxhidden input[type="password"]{height:22px;}
    </style>
</asp:Content>

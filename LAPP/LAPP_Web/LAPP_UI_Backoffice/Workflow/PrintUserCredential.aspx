<%@ Page Title="" Language="C#" MasterPageFile="~/LAPP_UI_Backoffice/MasterPage/1Column.master" AutoEventWireup="true" CodeFile="PrintUserCredential.aspx.cs" Inherits="LAPP_UI_Backoffice_Workflow_PrintUserCredential" %>

<%@ Register Src="~/Module/UI_Backoffice/Workflow/ucPrintUserCredential.ascx" TagName="ucPrintUserCredential"
    TagPrefix="uc1" %>
...
<link rel="stylesheet" type="text/css" href="../../App_Themes/Theme1/css/ieAll.css" />
    ...
    <div class="get-started-content">
        <uc1:ucPrintUserCredential ID="ucPrintUserCredential1" runat="server" />
    </div>
</asp:Content>

<%@ Page Title="" Language="C#" MasterPageFile="~/LAPP_UI_Backoffice/MasterPage/1Column.master" AutoEventWireup="true" CodeFile="PSDWaitingRoom.aspx.cs" Inherits="LAPP_UI_Backoffice_PSD_PSDWaitingRoom" %>
<%@ Register Src="~/Module/UI_Backoffice/Workflow/ucPSDWaitingRoom.ascx" TagPrefix="uc1" TagName="ucPSDWaitingRoom" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MidContent" runat="server">
    <div class="get-started-content">
        <uc1:ucPSDWaitingRoom runat="server" ID="ucPSDWaitingRoom" />
    </div>
    <script>

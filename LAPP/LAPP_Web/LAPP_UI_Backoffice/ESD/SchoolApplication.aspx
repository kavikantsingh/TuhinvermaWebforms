<%@ Page Language="C#" MasterPageFile="~/LAPP_UI_Backoffice/MasterPage/1Column.master" AutoEventWireup="true" CodeFile="SchoolApplication.aspx.cs" Inherits="LAPP_UI_Backoffice_ESD_SchoolApplication" %>

<%@ Register Src="~/Module/UI_Backoffice/ESD/ucSchoolApplication.ascx" TagName="ucSchoolApplication" TagPrefix="uc1" %>
...
<link rel="stylesheet" type="text/css" href="../../App_Themes/Theme1/css/ieAll.css" />
    ...
    <style>
        table#ContentPlaceHolder1_ucSchoolApplication1_rblGenderEdit td {
...
<asp:Content ID="Content2" ContentPlaceHolderID="MidContent" runat="Server">
    <div class="get-started-content">
        <uc1:ucSchoolApplication ID="ucSchoolApplication1" runat="server" />
    </div>
    <script type="text/javascript">

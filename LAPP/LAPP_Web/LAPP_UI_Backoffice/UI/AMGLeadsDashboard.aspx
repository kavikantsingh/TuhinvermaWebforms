<%@ Page Title="" Language="C#" MasterPageFile="~/LAPP_UI_Backoffice/MasterPage/MainPage.master" AutoEventWireup="true" CodeFile="AMGLeadsDashboard.aspx.cs" Inherits="LAPP_UI_Backoffice_UI_AMGLeadsDashboard" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <style>
        ...
        .tableWidth{
             float: left; font-size:9px; margin-top: 10px; line-height: 25px; margin-left: 5px;
        }
    </style>
</asp:Content>
                                            ...
                                            <div class="get-started-content pdng5">
                                                ...
                                                <div style="width: 99.8%" class="clear brdr" id="SCLAppli">
                                                    <table class="index">
                                                        <tbody>
                                                            <tr>
                                                                <th colspan="2" style="text-align: left !important;background-color: #93d28f; color: black;" class="hedding">Certification
                                                                </th>
                                                            </tr>
                                                            <tr>
                                                                <td colspan="2" class="pdgnone">
                                                                <table class="matrix index tableWidth" style="width: 99%;" border="1">
                                                                        <tr>
                                                                            <th style="background-color: rgb(255, 255, 255) ! important; color: black; width:10%;">Waiting on Payment</th>
                                                                            <th style="background-color: rgb(255, 255, 255) ! important; color: black; width:10%; line-height: 15px !important;">Submitted-Incomplete</th>
                                                                            <th style="background-color: rgb(255, 255, 255) ! important; color: black; width:10%;">Waiting on Background Check</th>
                                                                            <th style="background-color: rgb(255, 255, 255) ! important; color: black; width:10%;">Waiting on School Transcript</th>
                                                                            <th style="background-color: rgb(255, 255, 255) ! important; color: black; width:10%;">Waiting on Exam Results</th>
                                                                            <th style="background-color: rgb(255, 255, 255) ! important; color: black; width:10%;">Application Deficiency</th>
                                                                            <th style="background-color: rgb(255, 255, 255) ! important; color: black; width:10%;">Final QA</th>
                                                                            <th style="background-color: rgb(255, 255, 255) ! important; color: black; width:9%;">Preapproved</th>
                                                                            <th style="background-color: rgb(255, 255, 255) ! important; color: black; width:10%;">Approved</th>                                                                            
                                                                            <th style="background-color: rgb(255, 255, 255) ! important; color: black; width:10%;">Printing / Mailing</th>
                                                                        </tr>
                                                                        <tr>
                                                                            <td><a href="">23</a></td>
                                                                            <td><a href="../ESD/SchoolApplication.aspx" target="_blank" id="ScholOverflowLink2">14</a></td>
                                                                            <td><a href="">14</a></td>
                                                                            <td><a href="">55</a></td>
                                                                            <td><a href="">10</a></td>
                                                                            <td><a href="">11</a></td>
                                                            ...
                                                            <table class="index" style="margin-top: 20px;">
                                                                <tbody>
                                                            <tr>
                                                                <th colspan="2" style="text-align: left !important; background-color: rgb(189, 215, 238);
color: black;" class="hedding">Recertification
                                                                </th>
                                                            </tr>
                                                            <tr>
                                                                <td colspan="2" class="pdgnone">                                                                    
                                                                    <table class="matrix index tableWidth" style="width: 70%;" border="1">
                                                                        <tr>
                                                                            <th style="background-color: rgb(255, 255, 255) ! important; color: black; width: 10%;">Waiting on Payment</th>
                                                                            <th style="background-color: rgb(255, 255, 255) ! important; color: black; width: 10%; line-height: 15px !important;">Submitted-Incomplete</th>
                                                                            <th style="background-color: rgb(255, 255, 255) ! important; color: black; width: 10%;">Application Deficiency</th>
                                                                            <th style="background-color: rgb(255, 255, 255) ! important; color: black; width: 10%;">Final QA</th>
                                                                            <th style="background-color: rgb(255, 255, 255) ! important; color: black; width: 10%;">Preapproved</th>
                                                                            <th style="background-color: rgb(255, 255, 255) ! important; color: black; width: 10%;">Approved</th>                                                                            
                                                                            <th style="background-color: rgb(255, 255, 255) ! important; color: black; width: 10%;">Printing / Mailing</th>
                                                                        </tr>
                                                                        <tr>
                                                    ...
                                                    <table class="index" style="margin-top: 20px;">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td colspan="2" class="pdgnone">
                                                                   <table class="matrix index tableWidth" style="width: 90%; margin-bottom: 20px;" border="1">
                                                                        <tr>
                                                                            <th style="background-color: rgb(255, 255, 255) ! important; color: black; width: 10%;">Waiting on Payment</th>
                                                                            <th style="background-color: rgb(255, 255, 255) ! important; color: black; width: 10%; line-height: 15px !important;">Submitted-Incomplete</th>
                                                                            <th style="background-color: rgb(255, 255, 255) ! important; color: black; width: 10%;">Waiting on Transcript</th>
                                                                            <th style="background-color: rgb(255, 255, 255) ! important; color: black; width: 10%;">Waiting on Exam</th>
                                                                            <th style="background-color: rgb(255, 255, 255) ! important; color: black; width: 10%;">Application Deficiency</th>
                                                                            <th style="background-color: rgb(255, 255, 255) ! important; color: black; width: 10%;">Final QA</th>
                                                                            <th style="background-color: rgb(255, 255, 255) ! important; color: black; width: 10%;">Preapproved</th>
                                                                            <th style="background-color: rgb(255, 255, 255) ! important; color: black; width: 10%;">Approved</th>                                                                            

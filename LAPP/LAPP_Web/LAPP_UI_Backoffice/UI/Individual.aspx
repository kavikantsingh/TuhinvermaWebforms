<%@ Page Title="" Language="C#" MasterPageFile="~/LAPP_UI_Backoffice/MasterPage/MainPage.master" AutoEventWireup="true"
    CodeFile="Individual.aspx.cs" Inherits="NVBMT_WebProject_UI_Individual" %>
...
<%@ Register Src="~/Module/UI_Backoffice/Individual/ucDoSubinOpposition.ascx" TagPrefix="ucDSO" TagName="ucDoSubinOpposition" %>
<%@ Register Src="~/Module/UI_Backoffice/Individual/ucAppCertificate.ascx" TagPrefix="uc50" TagName="ucAppCertificate" %>
                                            ...
                                            <div id="Cashflow" class=" clearfix">
                                                <div class="gridUpperDiv">
                                                    ...
                                                    <div class="fltrt rightIcon">
                                                        ...
                                                        <asp:ImageButton ID="imgbtnIHS" runat="server" ToolTip="IHC" ImageUrl="~/App_Themes/Theme1/images/I.png"
                                                             />
                                                        <asp:ImageButton ID="imgbtnPSD" runat="server" ToolTip="PSD" ImageUrl="~/App_Themes/Theme1/images/P.png"
                                                             />
                                                        <asp:ImageButton ID="imgbtnLegal" runat="server" ToolTip="Legal" ImageUrl="~/App_Themes/Theme1/images/L.png"
                                                             />
                                                ...
                                                <div id="divButtonList" class="tabBtnBorder">
                                                    <asp:Button ID="btnGeneral" Enabled="true" runat="server" Text="General" OnClick="btnGeneral_Click" CssClass="tab_activeBtn" />
                                                    <asp:Button ID="btnPersonal" Enabled="false" runat="server" Text="Personal" OnClick="btnPersonal_Click" CssClass="tabBtn" />
                                                    <asp:Button ID="btnAddress" Enabled="false" runat="server" Text="Address" OnClick="btnAddress_Click" CssClass="tabBtn" />
                                                    <asp:Button ID="btnFinancial" Enabled="false" runat="server" Text="Financial" OnClick="btnFinancial_Click" CssClass="tabBtn" />
                                                    <asp:Button ID="btnName" Enabled="false" runat="server" Text="Name" OnClick="btnName_Click" CssClass="tabBtn"/>
                                                    <asp:Button ID="btnEducation" Enabled="false" runat="server" Text="Education" OnClick="btnEducation_Click" CssClass="tabBtn"/>
                                                    <asp:Button ID="btnEmployment" Enabled="false" runat="server" Text="Employment" OnClick="btnEmployment_Click" CssClass="tabBtn"/>
                                                    <asp:Button ID="btnApplicationData" Enabled="false" runat="server" Text="App/Certificate" OnClick="btnApplicationData_Click" CssClass="tabBtn"/>
                                                    <asp:Button ID="btnCertificate" Enabled="false" Visible="false" runat="server" Text="Certificate" OnClick="btnCertificate_Click" CssClass="tabBtn"/>
                                                    <asp:Button ID="btnPSD" Enabled="false" runat="server" Text="PSD" OnClick="btnPSD_Click" CssClass="tabBtn"/>
                                                    <asp:Button ID="btnDOJFBI" Enabled="false" runat="server" Text="DOJ/FBI" OnClick="btnDOJFBI_Click" CssClass="tabBtn"/>
                                                    <asp:Button ID="btnDeficiency" Enabled="false" runat="server" Text="Deficiency" OnClick="btnDeficiency_Click" CssClass="tabBtn"/>

                                                    <asp:Button ID="btnNotes" Enabled="false" runat="server" Text="Notes" OnClick="btnNotes_Click" CssClass="tabBtn"/>
                                                    ...
                                                    <asp:Button ID="btnCityReportsSearches" Enabled="false" Visible="false" runat="server" Text="City/Reports/Searches" OnClick="btnCityReportsSearches_Click" CssClass="tabBtn"/>
                                                            ...
                                                            <div class="divindv">
                                                                <div class="brandytest">
                                                                    ...
                                                                    <table class="IndividualTbl">
                                                                        ...
                                                                        <tr>
                                                                            <td>CMT Pending <span class="indfnt">
                                                                                <label> 10/01/2013</label></span>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>CMT Expired <span class="indfnt">
                                                                                <label>&nbsp; 10/01/2012</label></span>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>CMT Renewed <span class="indfnt">
                                                                                <label>
                                                                                    10/01/2011</label></span>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </div>
                                                ...
                                                <div id="divPanelList" style="border: 1px solid rgb(222, 222, 222); margin-top: 10px;">
                                                    ...
                                                    <asp:Panel ID="pnlName" Enabled="true"  Visible="false" runat="server">
                                                        <uc6:ucName ID="ucName1" runat="server" />
                                                    </asp:Panel>
                                                    ...
                                                    <asp:Panel ID="pnlDoSubinOpposition" Enabled="true" Visible="false" runat="server">
                                                        <ucDSO:ucDoSubinOpposition runat="server" ID="ucDoSubinOpposition1" />
                                                    </asp:Panel>

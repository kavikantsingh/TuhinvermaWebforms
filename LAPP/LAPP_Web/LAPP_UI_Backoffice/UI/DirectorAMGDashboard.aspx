<%@ Page Title="" Language="C#" MasterPageFile="~/LAPP_UI_Backoffice/MasterPage/MainPage.master" AutoEventWireup="true" CodeFile="DirectorAMGDashboard.aspx.cs" Inherits="LAPP_UI_Backoffice_UI_DirectorAMGDashboard" %>
                                                ...
                                                <div style="width: 99.8%" class="clear brdr" id="SCLAppli">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td colspan="2" class="pdgnone">
                                                                    <div style="float: left; width: 8%; text-align: right; padding-top: 81px; font-size: 9px;"><b>Average Days in Queue</b></div>
                                                                    <table class="matrix index tableWidth" style="width: 90%;" border="1">
                                                                        <tr>
                                                                            <th style="background-color: rgb(255, 255, 255) ! important; color: black; width:9%;">Waiting on Payment</th>
                                                                            <th style="background-color: rgb(255, 255, 255) ! important; color: black; width:9%; line-height: 15px !important;">Submitted-Incomplete</th>
                                                                            <th style="background-color: rgb(255, 255, 255) ! important; color: black; width:9%;">Waiting on Background Check</th>
                                                                            <th style="background-color: rgb(255, 255, 255) ! important; color: black; width:9%;">Waiting on School Transcript</th>
                                                                            <th style="background-color: rgb(255, 255, 255) ! important; color: black; width:9%;">Waiting on Exam Results</th>
                                                                            <th style="background-color: rgb(255, 255, 255) ! important; color: black; width:9%;">Application Deficiency</th>
                                                                            <th style="background-color: rgb(255, 255, 255) ! important; color: black; width:9%;">Final QA</th>
                                                                            <th style="background-color: rgb(255, 255, 255) ! important; color: black; width:9%;">Preapproved</th>
                                                                            <th style="background-color: rgb(255, 255, 255) ! important; color: black; width:9%;">Approved</th>                                                                            
                                                                            <th style="background-color: rgb(255, 255, 255) ! important; color: black; width:9%;">Printing / Mailing</th>
                                                                        </tr>
                                                                        <tr>
                                                                            <td><a href="">23</a></td>
                                                                            <td><a href="../ESD/SchoolApplication.aspx" target="_blank" id="ScholOverflowLink">14</a></td>
                                                                            <td><a href="">14</a></td>
                                                                            <td><a href="">55</a></td>
                                                                            <td><a href="">10</a></td>
                                                                            <td><a href="">11</a></td>
                                                    ...
                                                    <table class="index" style="margin-top: 20px;">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td colspan="2" class="pdgnone">
                                                                    <div style="float: left; width: 8%; text-align: right; padding-top: 64px; font-size: 9px;"><b>Average Days in Queue</b></div>
                                                                    <table class="matrix index tableWidth" style="width: 63%;" border="1">
                                                                        <tr>
                                                                            <th style="background-color: rgb(255, 255, 255) ! important; color: black; width: 9%;">Waiting on Payment</th>
                                                                            <th style="background-color: rgb(255, 255, 255) ! important; color: black; width: 9%; line-height: 15px !important;">Submitted-Incomplete</th>
                                                                            <th style="background-color: rgb(255, 255, 255) ! important; color: black; width: 9%;">Application Deficiency</th>
                                                    ...
                                                    <table class="index" style="margin-top: 20px;">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td colspan="2" class="pdgnone">
                                                                    <div style="float: left; width: 8%; text-align: right; padding-top: 64px; font-size: 9px;"><b>Average Days in Queue</b></div>
                                                                    <table class="matrix index tableWidth" style="width: 81%; margin-bottom: 20px;" border="1">
                                                                        <tr>
                                                                            <th style="background-color: rgb(255, 255, 255) ! important; color: black; width: 9%;">Waiting on Payment</th>
                                                                            <th style="background-color: rgb(255, 255, 255) ! important; color: black; width: 9%; line-height: 15px !important;">Submitted-Incomplete</th>
                                                                            <th style="background-color: rgb(255, 255, 255) ! important; color: black; width: 9%;">Waiting on Transcript</th>
                                                                            <th style="background-color: rgb(255, 255, 255) ! important; color: black; width: 9%;">Waiting on Exam</th>
                                                                            <th style="background-color: rgb(255, 255, 255) ! important; color: black; width: 9%;">Application Deficiency</th>
                                                                            <th style="background-color: rgb(255, 255, 255) ! important; color: black; width: 9%;">Final QA</th>
                                                                            <th style="background-color: rgb(255, 255, 255) ! important; color: black; width: 9%;">Preapproved</th>
                                                                            <th style="background-color: rgb(255, 255, 255) ! important; color: black; width: 9%;">Approved</th>                                                                            

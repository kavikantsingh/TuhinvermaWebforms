<%@ Page Language="C#" AutoEventWireup="true" CodeFile="register.aspx.cs" Inherits="LAPP_UI_Individual_UI_register" %>
        ...
        <form action="" runat="server" class="sky-form">
            ...
            <asp:Panel ID="upRegistration" runat="server">
                <fieldset>
                    ...
                    <section>
                        <label class="input">
                            <input type="text" placeholder="Date of Birth" style="background-image: none;" data-beatpicker="true" data-beatpicker-position="['right','*']" data-beatpicker-module="clear">

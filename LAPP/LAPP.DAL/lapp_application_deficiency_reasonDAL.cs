...
namespace LAPP.DAL
{
    public class lapp_application_deficiency_reasonDAL : BaseDAL
    {
        public int Save_lapp_application_deficiency_reason(lapp_application_deficiency_reason objlapp_application_deficiency_reason)
        {
            ...
            lstParameter.Add(new MySqlParameter("Deficiency_Reason_Message", objlapp_application_deficiency_reason.Description));
            ...
            lstParameter.Add(new MySqlParameter("Additional_Text", objlapp_application_deficiency_reason.Additional_Text));
            lstParameter.Add(new MySqlParameter("Deficiency_Template_ID", objlapp_application_deficiency_reason.Deficiency_Template_ID));
        ...
        public int Update_lapp_application_deficiency_reason(lapp_application_deficiency_reason objlapp_application_deficiency_reason)
        {
            ...
            lstParameter.Add(new MySqlParameter("U_Additional_Text", objlapp_application_deficiency_reason.Additional_Text));
            lstParameter.Add(new MySqlParameter("U_Deficiency_Template_ID", objlapp_application_deficiency_reason.Deficiency_Template_ID));
